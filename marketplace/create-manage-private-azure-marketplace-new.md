...
> [!NOTE]
> Den här artikeln beskriver privata Azure Marketplace samlingar. Den äldre vyn beskrivs i den [ursprungliga artikeln i](create-manage-private-azure-marketplace.md) stället.
...
Som Marketplace-administratör (tilldelad roll) börjar du med en inaktiverad och tom privat marknadsplats och en samling där du kan lägga till dina godkända erbjudanden och planer. Den här artikeln förklarar hur du tilldelar den roll som krävs, skapar ett privat arkiv, hanterar samlingar och objekt, godkänner användarbegäranden och aktiverar privata Azure Marketplace för dina användare.

> [!NOTE]
> - Privat Azure Marketplace på klientorganisationsnivå; När den har aktiverats anges principen för alla användare under klientorganisationen.
...
Dessa krav måste vara uppfyllda innan du kan tilldela rollen Marketplace-administratör till en användare i klientorganisationsomfånget:
...
1. Välj **Privat Marketplace** på menyn till vänster.
   ...
   :::image type="content" source="media/private-azure/private-marketplace.png" lightbox="media/private-azure/private-marketplace-zoom.png" alt-text="Visar menyalternativet privat marknadsplats till vänster på Marketplace.":::
...
> [!NOTE]
> För gästanvändare som bjudits in till klientorganisationen kan det ta upp till 48 timmar innan deras konto är tillgängligt för tilldelning av administratörsrollen för Marketplace. Mer information finns i Egenskaper [för en Azure Active Directory B2B-samarbetsanvändare.](/azure/active-directory/b2b/user-properties)
...
4. Välj **Kom igång** att skapa privat Azure Marketplace (du behöver bara göra detta en gång).

    :::image type="content" source="media/private-azure-new/private-marketplace-get-started.png" alt-text="Visar hur du väljer &quot;Kom igång i Azure Portal&quot;-huvudfönstret.":::
...
5. När du är klar har du en inaktiverad privat Azure Marketplace med en **standardsamling**.
    ...
    > [!NOTE]
    > - **Standardsamling** är en systemgenererad samling med omfånget för alla prenumerationer under samma klientorganisation.
...
4. När du lägger till ett nytt erbjudande läggs som standard alla aktuella planer till i listan över godkända planer. Om du vill ändra valet av plan innan du lägger till de valda objekten väljer du den nedrullningslade menyn i erbjudandets panel och uppdaterar de planer som krävs.
...
1. I kolumnen **Planer** granskar du de tillgängliga planerna i listrutan för objektet.

2. Markera eller avmarkera kryssrutorna för att välja vilka planer som ska vara tillgängliga för dina användare.
   ...
   > [!NOTE]
   > Varje erbjudande måste ha minst en vald plan för att uppdateringen ska ske. Om du vill ta bort alla planer som är relaterade till ett erbjudande tar du bort hela erbjudandet (se nästa avsnitt).
...
1. På **sidan Hantera** samling visas en banderoll som visar samlingens aktuella tillstånd:
...
1. På sidan **Hantera Marketplace** väljer du samlingen och använder det översta åtgärdsfältet för att aktivera eller inaktivera samlingen.
   ...
   :::image type="content" source="media/private-azure-new/action-bar.png" alt-text="Visar åtgärdsfältet Hantera Marketplace med knapparna aktivera och inaktivera samlingar.":::

### <a name="enabledisable-private-azure-marketplace"></a>Aktivera/inaktivera privat Azure Marketplace

På sidan Hantera Marketplace visas en av dessa banderoller som visar det aktuella tillståndet för Privat Azure Marketplace:
   ...
   :::image type="content" source="media/private-azure-new/state-enable.png" alt-text="Visar banderollen Privat Azure Marketplace aktiverat.":::
...
Med samlingar kan Marketplace-administratör (tilldelad roll) skapa flera listor med godkända objekt som är tillgängliga för olika prenumerationer i organisationen.
...
5. Detta skapar en ny tom och inaktiverad Privat samling. Välj ett samlingsnamn för att hantera det.
...
> [!NOTE]
> **Standardsamling** är en systemgenererad samling som inte kan tas bort.

## <a name="private-azure-marketplace-notification-center"></a>Meddelandecenter Azure Marketplace privat resurs

Meddelandecenter består av tre typer av meddelanden och gör att Marketplace-administratören kan vidta åtgärder baserat på meddelandet:
...
När Privat Azure Marketplace har aktiverats ser användarna vilka planer som Marketplace-administratören har godkänt.
...
- När en användare väljer en icke-godkänd plan eller prenumeration ser en banderoll  planen som inte godkänd för den valda prenumerationen och knappen Skapa inaktiveras. Användaren kan fortfarande begära att planen ska läggas till i listan över godkända (se nästa avsnitt).
...
1. Välj vilka planer som ska läggas till i begäran ( Alla **planer** talar om för Marketplace-administratören att du inte har någon inställning för en specifik plan i ett erbjudande).
...
Privata Azure Marketplace ger större flexibilitet när det gäller att begränsa och tillåta specifika erbjudanden och planer. Den informerar slutanvändarna om tillgängligheten för distribution i Marketplace-galleriet även innan de försöker distribuera tjänster från tredje part. Om du vill tillåta distribution av tjänster från tredje part Azure Marketplace till På/Aktiverad EA-portalen och Azure Portal.
...
#### <a name="why-do-i-see-some-offers-approved-by-default-even-though-the-partner-is-not-microsoft"></a>Varför visas vissa erbjudanden godkända **som standard även** om partnern inte är Microsoft?
...
- Om Azure Marketplace support går du till [Microsoft Q&A](/answers/products/).
