...
ms.locfileid: "128322058"
---
# <a name="saas-subscription-lifecycle-management"></a>Livscykelhantering för SaaS-prenumeration

Den här artikeln beskriver hur du identifierar en SaaS-resurs, skillnaderna mellan SaaS och SaaS Classic samt SaaS-resurshantering i Azure Portal.
