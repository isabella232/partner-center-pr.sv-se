...
2. Acceptera Microsoft-partneravtal och aktivera kontot.
...
- **Fält & stad/provins:** Kontrollera att kombinationen mellan staden och delstaten/regionen är korrekt. Det finns länder där den nedrullningsbara menyn för att välja delstat/provins kommer att gälla, och i andra länder måste fältet infogas manuellt.
...
- **Telefon:** Kontrollera att Telefon inte innehåller specialtecken, blanksteg eller landskod. Det värde som anges Telefon fältet Antal innehåller alltid högst 10 tecken.
