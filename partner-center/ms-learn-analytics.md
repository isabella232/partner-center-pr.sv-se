...
**Trendminidiagram för tränade** individer: Kumulativt antal aktiva elever per månad 
...
Om till exempel Learning sökvägen "Sökväg 1" slutförs av 20 individer och Learning-sökvägen "sökväg 2" har slutförts av samma 20 individer, blir antalet slutförda Learning-sökvägar 40. Slutförandedatumet Learning sökvägen ska vara inom det valda datumintervallet.

**Learning för slutförda utbildningsvägstrender i minidiagram:** Kumulativt antal utbildningsvägsslutningar för månad över månad 

### <a name="trained-individuals-monthly-trend"></a>Tränade individers månatliga trend

Dessa data är trenden för företagets användare som har slutfört en modul för första gången den månaden. 
...
- Slutförande per produkt: uppdelning av modulsluten efter den produkt som modulen mappas till. Om en modul är associerad med flera produkter läggs var och en av produkterna till i antalet slutförda moduler.    
...
>[!NOTE] 
> Du kan ladda ned rådata som driver den här rapporten från avsnittet Ladda ned rapporter i Insights instrumentpanel. [Läs mer](pci-download-reports.md) 
