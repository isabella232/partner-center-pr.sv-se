...
| MpnId | Microsoft Partner Network (MPN) för den Molnlösningsleverantör (CSP)-partnern. | *4390934* |
...
| ServiceInfo | Antalet anslutningar Azure Service Bus som har etablerats och använts en viss dag. | *1.000000 anslutningar/30* dagar (om du hade en individuellt etablerad anslutning under en 30-dagars månad), *25 anslutningar/30 dagar – används: 1.000000* (om du hade ett 25 paket med Service Bus-anslutningar etablerade och du använde 1 under den dagen) |
