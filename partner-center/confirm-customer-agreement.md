...
**Alternativ 2:** Kundens direkta godkännande – Partner kan bjuda in kunden via en URL för att granska och godkänna avtalet i Microsoft 365 Administrationscenter.
...
4. Under **Godkännandedatum för avtal** anger du lämpligt datum. Du kan inte ange detta till ett framtida datum.

5. Kontrollera att den primära användarens kontaktinformation som visas är korrekt. Om det är felaktigt väljer **du Uppdatera** och anger korrekt information för den person som godkände avtalet.
...
4. Ange **förnamn,** **efternamn,** **e-postadress** och **telefonnummer (valfritt)** för den person som godkände avtalet. Under **Godkännandedatum för avtal** anger du lämpligt datum. Du kan inte ange detta till ett framtida datum.
...
Du kan använda Partner Center API/SDK för att bekräfta att kunden godkänner Microsoft-kundavtal. Mer information om API/SDK finns i:
...
## <a name="option-2-customer-acceptance-in-microsoft-365-admin-center"></a>Alternativ 2: Kundgodkännande i Microsoft 365 Administrationscenter

Partner kan bjuda in nya och befintliga kunder via en URL för att granska och godkänna avtalet i Microsoft 365 Administrationscenter. Följande avsnitt visar hur du:
...
Använd följande steg för att skapa en ny kund i Partnercenter och sedan bjuda in dem att granska och godkänna Microsoft-kundavtal i Microsoft 365 Administrationscenter.
...
3. Under **Kundavtal** väljer **du Kund om du vill godkänna Microsoft-kundavtal i Microsoft 365 administrationscenter.** Fyll i alla andra obligatoriska fält på sidan.

4. Välj **Nästa: Granska och** fortsätt sedan med stegen för att skapa kundens klientorganisation. 
...
5. När du kommer till **bekräftelseskärmen** i det nya kundarbetsflödet sparar du kundens autentiseringsuppgifter. Du måste ge dessa autentiseringsuppgifter till kunden senare.

6. Utanför Partnercenter skapar och skickar du ett e-postmeddelande som uppmanar kunden att godkänna Microsoft-kundavtal i Microsoft 365 Administrationscenter. Se till att inkludera dessa objekt i e-postmeddelandet:
...
8. Kunden loggar in på Microsoft 365-administrationscentret med de kundautentiseringsuppgifter som du angav.
...
2. En automatisk e-postmall genereras, inklusive text och en parametriserad URL som dirigerar kunden Microsoft 365 administrationscentret.
...
6. Kunden använder de autentiseringsuppgifter som du anger i e-postmeddelandet för att logga Microsoft 365 Administrationscenter.
...
3. Kunden anger sina autentiseringsuppgifter i Microsoft 365 Administrationscenter.
...
Det finns två scenarier där kunder kanske inte kan godkänna Microsoft-kundavtal i Microsoft 365 administrationscenter.
...
När kunden klickar på URL:en till Microsoft 365-administrationscentret för att godkänna den nya partnerrelationen och avtalet får de meddelandet "Kontakta din partner för att bekräfta att du godkänner Microsoft-kundavtal".  
...
1. Ange **förnamn,** **efternamn,** **e-postadress** och **telefonnummer (valfritt)** för den användare som godkände avtalet.

2. Under **Godkännandedatum för avtal** anger du lämpligt datum. Du kan inte ange detta till ett framtida datum.
