...
Du kan manuellt [ladda ned den senaste versionen av Microsoft-kundavtal](https://aka.ms/customeragreement). Den Microsoft-kundavtal är landsspecifik. När du Microsoft-kundavtal mallen måste du välja rätt land baserat på kundens plats.
