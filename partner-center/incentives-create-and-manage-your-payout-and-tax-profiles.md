...
Som standard görs incitaments betalningar i den lokala valutan för varje respektive enhet. Du kan ange en annan valuta under profil installationen. Betalningarna beräknas med en växelkurs som ställs in månatlig av Microsoft. Du ansvarar för alla ändringar i värdet på grund av vald valuta.

### <a name="bank-and-tax-information-and-other-programs"></a>Bank-och skatte information och andra program

Ange den information som beskrivs nedan även om Microsoft redan använder dina bank data för betalningar. Detta säkerställer sekretessen och säkerheten för företagets data, eftersom kopiering av din profil till det nya verktyget kan exponera känslig information. Att gå igenom den här processen är också en bra möjlighet att se till att informationen är fullständig och korrekt.

### <a name="using-different-profiles-for-different-microsoft-programs"></a>Använda olika profiler för olika Microsoft-program

Inom detalj handeln kan betalningar för var och en av de fem åter betalnings programmen gå till samma bank konto. Alternativt kan du välja att använda Xbox-betalningar på ett bank konto medan butiks kontoret betalas till ett annat bank konto.
