...
1. Från [instrumentpanelen i Partnercenter](https://partner.microsoft.com/dashboard)väljer du Inställningar kugghjulsikon och sedan **Kontoinställningar.**

2. Välj **Användarhantering.**

3. Längst upp i användarlistan väljer du **listrutan** Filter. Ändra alternativet till **Kontoadministratör.**
...
- PSC-användare kan använda ett icke-arbetskonto.

- PSC-användaren kanske använder ett konto från en annan domän än den du använder i Partnercenter.
...
- Användaren har redan en referensroll tilldelad i Partnercenter.
...
- Avtal som har markerats som vann i PSC är inte berättigade till migrering. Avtalsregistrering om den är berättigad till de avtal som markerats som won ska slutföras i PSC.
...
|Lösningar|Lösningar som endast tillhör en prislista kan läggas till i ett avtal.|Partner kan lägga [till](manage-co-sell-opportunities.md#add-solutions) lösningar som tillhör följande listor. a) Deras egna lösningar b) Lösningar från Microsofts katalog för första part (liknar rollen Transaktionsavtal i PSC) och c) Säljavtalslösningar från andra tredjepartspartner (liknar ISV-avtalsrollen i PSC).|
|Avtalstilldelning|Endast en tilldelad säljare kan visa och agera på affärerna.|Teammedlemmar kan läggas till i ett avtal för att ange vilka personer som arbetar med ett avtal, det finns ingen blockering av andra hänvisningsadministratörer från att visa eller agera på dessa avtal.|
...
- PSC-startsida mappad till standardvyn för möjligheter till säljförsäljning i Partnercenter
- PSC-rutnätsvy mappad till partnercenter-avtalsvyn
- Vy över PSC-avtalsinformation som är mappad till partnercenter-avtalsinformationsvyn
- PSC-vyn Lägg till produkter mappad till Vyn Lägg till lösningar i Partnercenter
- PSC-användarhanteringsvy mappad till användarhanteringsvyn i Partnercenter
- Vy för PSC-användarrolltilldelning mappad till vyn För Partnercenter-rolltilldelning
- Vy för PSC-meddelanden som är mappad till meddelandevyn i Partnercenter

### <a name="psc-home-page-mapped-to-the-partner-center-co-sell-opportunities-default-view"></a>PSC-startsida mappad till standardvyn för möjligheter till säljförsäljning i Partnercenter
...
### <a name="psc-grid-view-mapped-to-the-partner-center-deal-view"></a>PSC-rutnätsvy mappad till partnercenter-avtalsvyn
...
### <a name="psc-add-products-view-mapped-to-the-partner-center-add-solutions-view"></a>PSC-vyn "Lägg till produkter" mappad till vyn Lägg till lösningar i Partnercenter
...
### <a name="user-management-in-psc-versus-partner-center"></a>Användarhantering i PSC jämfört med Partnercenter

Jämför den matchande, numrerade cirklarna längst upp (PSC)-skärmbilden med Partnercenter-skärmbilden nedanför. Matchande tal visar var du hittar den PSC-relaterade funktionen eller attributet i Partnercenter. Röda cirklar visar att det inte finns något matchande fält eller område i Partnercenter.  

 :::image type="content" source="images/pscmigration/usermanagement.png" alt-text="Bild som visar fältmappningarna mellan användarhanteringsplatsen Anslut Partner sales (PSC) och användarhanteringssidan i området Kontoinställningar."  lightbox="images/pscmigration/user-management-expanded.png":::

### <a name="user-role-assignment-in-psc-versus-partner-center"></a>Tilldelning av användarroller i PSC jämfört med Partnercenter
...
### <a name="what-should-i-do-if-i-dont-have-access-to-partner-center"></a>Vad gör jag om jag inte har åtkomst till Partnercenter?
...
### <a name="the-new-deal-button-is-greyed-out-for-our-account-what-should-i-do-to-start-creating-deals"></a>Knappen +Nytt avtal är nedtonad för vårt konto. Vad ska jag göra för att börja skapa avtal?
...
### <a name="can-i-assign-deals-to-a-specific-person-from-our-organization-like-psc"></a>Kan jag tilldela avtal till en viss person från vår organisation, till exempel PSC?
...
### <a name="is-there-a-view-of-all-the-deals-assigned-to-me"></a>Finns det någon vy över alla avtal som tilldelats mig?
...
### <a name="is-there-a-read-only-view-for-the-deals"></a>Finns det en skrivskyddade vy för avtal?
...
### <a name="how-can-i-register-a-deal-after-marking-it-as-won"></a>Hur registrerar jag ett avtal när jag har märkt det som vunnit?
...
### <a name="i-get-an-error-message-when-i-select-the-new-deal-registration-button-in-the-deal-registration-section-how-can-i-register-my-deals"></a>Jag får ett felmeddelande när jag väljer knappen "+Ny avtalsregistrering" i avsnittet Avtalsregistrering. Hur registrerar jag mina avtal?
...
### <a name="is-adding-a-customer-organization-mandatory"></a>Är det obligatoriskt att lägga till en kundorganisation?
...
### <a name="are-customer-contact-details-mandatory"></a>Är kundens kontaktuppgifter obligatoriska?
...
### <a name="how-many-solutions-can-i-add-to-a-deal"></a>Hur många lösningar kan jag lägga till i ett avtal?
...
### <a name="when-will-i-get-to-know-the-microsoft-seller-details-after-creating-a-deal"></a>När får jag information om Microsofts säljare när jag har skapat ett avtal?
...
### <a name="where-can-i-find-the-opportunity-id"></a>Var hittar jag affärsmöjlighets-ID:t?
...
### <a name="how-can-my-pdm-get-access-to-partner-center"></a>Hur kan min PDM få åtkomst till Partnercenter?
...
:::image type="content" source="images/pscmigration/finding-mpnid.png" alt-text="Bild som visar kontoinställningarna där partnern kan hitta sitt MPN-ID."  lightbox="images/pscmigration/finding-mpnid.png":::
