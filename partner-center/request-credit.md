...
2. Logga in på [instrumentpanelen i Partnercenter,](https://partner.microsoft.com/dashboard)välj frågetecknet (?) och välj sedan **Hjälp + support**.

3. Välj **Ny begäran.**

4. Välj **Bläddra bland ämnen** och välj **Kategori** = CSP, **Ämne** = Fakturering och **Underavsnitt** = Kreditförfrågningar och återbetalningar.

5. På sidan **Rekommenderade lösningar,** under **Behöver du mer hjälp? väljer** du **Ja.**

6. På sidan **Information** slutför du avsnittet **Probleminformation.** I **textrutan** Information anger du nödvändig information som beskrivs i formuläret för kredit- **eller** **återbetalning.**
...
2. Logga in på [instrumentpanelen i Partnercenter och](https://partner.microsoft.com/dashboard) välj **Tjänstförfrågningar.**
...
2. Välj frågetecknet (?), sedan **Hjälp + support och** välj sedan Ny **begäran.**

3. På sidan **Starta begäran hittar** du avsnittet **CSP – kunder, beställningar och prenumerationer**. I det här avsnittet väljer **du Välj en typ av problem** och sedan **Kreditförfrågningar för kundtjänst.**

4. På sidan **Rekommenderade lösningar,** under **Behöver du mer hjälp?** väljer du **Ja.**

5. På sidan **Information** fyller du i **avsnittet Probleminformation.** I **textrutan** Information måste du ange den information som du samlade in tidigare.

6. Välj **Skicka** för att skicka i din SLA-kreditförfrågan.
...
4. På sidan **Starta begäran hittar** du avsnittet **CSP – kunder, beställningar och prenumerationer**. I det här avsnittet väljer **du Välj en typ av problem** och sedan **Kreditförfrågningar för kundtjänst.**

5. På sidan **Rekommenderade lösningar,** under **Behöver du mer hjälp?** väljer du **Ja.**

6. På sidan **Information** fyller du i **avsnittet Probleminformation.** I **textrutan** Information måste du ange den information som du samlade in tidigare.
...
Du hittar identifieraren för avbrottsincidenten på Service Health i Administrationscenter för Microsoft 365. Incident-ID för avbrott är ett tal som föregås av en förkortning med två bokstäver som anger den berörda tjänsten (till exempel EX25194 för Exchange Online avbrott).
