...
3. Tillämpa lämpliga filter. (Se **viktig information** nedan.)
...
6. Filtrera den här kolumnen **för Adjustment-Förser** dig med . Du kan se månaden för varje justering i Kolumn S.
