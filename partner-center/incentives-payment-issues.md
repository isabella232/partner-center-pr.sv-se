...
Den här artikeln hjälper dig att lösa eventuella problem med intäkter eller betalningar i ditt incitamentsprogram. Ämnen som omfattas omfattar tidsinställning för betalningar, kontroll av berättigande till intäkter och vikten av att konfigurera utbetalnings- och skatteprofiler korrekt.
...
Statusen för din registrering visas på översiktssidan. När du har skapat dina profiler är din status **Verifierar registreringen**. När vi har verifierat din information ändras statusen **till Registrerad.** Den här statusen anger att din utbetalnings- och skatteprofil och din registrering har slutförts.
...
6. Filtrera den här kolumnen **för Adjustment-Besent**. Du kan se månaden för varje justering i Kolumn S.
...
Om du inte kan hitta någon betalnings- eller transaktionsinformation kontrollerar du om du har tillämpat rätt filter. Eftersom vissa programnamn har ändrats (till exempel om CSP 1T Direct Partner nu CSP Direct Bill Partner) kan du behöva använda flera val.
