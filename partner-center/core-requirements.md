...
| Kommunikationskrav | Kopia av det slutliga kommunikationsstycket (baserat på annonsering) som visar programspecifika kärnkrav |
...
| Kommunikationskrav | Händelseinbjudan och program<br><br>Händelsefoton<br><br>Presentationsmaterial om händelseinbjudan och presentationen inte uppfyller de grundläggande kraven |
...
### <a name="tradeshows-and-exhibitions"></a>Shower och shows
...
| Kategori | Bevis på körning    |
| ------ | ----------- |
| Grundläggande krav    | Företagets varumärkesnamn och kontaktinformation – interna regler för deltagare räcker om företagets/varumärkets namn ingår i kommunikationsmaterialet<br><br>Microsoft-innehåll |
| Kommunikationskrav   | Visa erbjudande med allmänna villkor. Faktiska kostnader upp till 25 % totalt av intjänade co-op-medel per användningsperiod. Surface-partner kan göra anspråk på upp till 100 % av intjänade co-op-medel per användningsperiod för berättigade aktivitetsutgifter. |
| Mått     | Sammanfattning av resultat |
|Berättigade utgifter    | Faktiska kostnader upp till 25 % totalt intjänade co-op-medel per användningsperiod för: Signering, visning, tryckt material<br><br>Giveaways<br><br>Avgift – myndighet: Marknadsföringstjänster, inklusive agentavgifter<br><br>Surface-partner kan göra anspråk på upp till 100 % av intjänade co-op-medel per användningsperiod för berättigade aktivitetsutgifter |

### <a name="on-site-champ"></a>On-site Eller
