...
| SubscriptionDescription | Namnet på det tjänsterbjudande som kunden har köpt, enligt definitionen i prislistan. (Den här kolumnen är ett identiskt fält **med OfferName**). |
...
| UnitType | Typen av enhet som mätaren debiteras i.  |
...
| PCToBCExchangeRate | Växelkurs som tillämpas för prissättningsvalutan för faktureringsvalutan. |
