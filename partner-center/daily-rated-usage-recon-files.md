...
| ServiceInfo1 | Antalet anslutningar Service Bus som etablerades och användes en viss dag. |
...
| EntitlementId | Representerar Id:t för Azure-prenumerationen. |
