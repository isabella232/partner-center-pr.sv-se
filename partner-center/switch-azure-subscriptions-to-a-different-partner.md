...
I det första avsnittet överföra en Azure-prenumeration till en [annan partner](#transferring-azure-subscriptions-to-another-partner)beskrivs hur en kund kan överföra en Microsoft Azure-prenumeration från en Molnlösningsleverantör (CSP) till en annan.

I nästa avsnitt, Överföra en tidigare [Azure-erbjudandeprenumeration](#transferring-a-previous-azure-offer-subscription-without-converting-it-to-the-azure-plan)utan att konvertera den till Azure-planen, beskrivs kortfattat hur den nya Azure-planen introduceras. Sedan beskrivs ett specialfall där vissa prenumerationer på det tidigare Azure-erbjudandet kan överföras till en annan CSP utan att konvertera dem till den nya Azure-planen.
...
Kunden, den aktuella tjänstleverantören och en ny tjänstleverantör har alla ansvarsområden när en kundprenumeration överförs till [en ny Azure-tjänstleverantör.](#responsibilities-when-transferring-a-customer-subscription-to-a-new-azure-service-provider) En kund bör planera att samarbeta med den aktuella partnern för att övergången ska gå smidigt.
 ...
 Information på hög nivå som hjälper Azure-prenumeranter att överföra prenumerationer till och från CSP-partner finns i Överföra Azure-prenumerationer mellan [prenumeranter och CSP:er.](/azure/cost-management-billing/manage/transfer-subscriptions-subscribers-csp)
...
- Prenumerationer som är associerade med följande erbjudanden kan inte överföras: Azure-plan, Office 365, Enterprise Mobility Suite och Microsoft Dynamics CRM.
...
|5     |[Gransknings-, sign-, &-returformulär](#step-5-the-customer-and-new-partner-review--return-the-form)       |         |[Gransknings-, sign-, &-returformulär](#step-5-the-customer-and-new-partner-review--return-the-form)         |
...
|7     |         |         |[Ta bort en gammal partner från kontot](#step-7-new-partner-removes-old-partner-from-account)         |
...
Kunden startar överföringsprocessen genom att meddela både Microsoft och den aktuella CSP-partnern genom att skriva (det vill säga inte verbalt) om sin begäran om att överföra en prenumeration.
...
> [!NOTE]
> Det är den aktuella partnerns ansvar att skapa supportbiljetten som initierar överföringsprocessen. Microsoft ingriper inte för kundens eller den nya partnerns räkning.
...
1. I steg 1 i supportbegäran väljer du Prenumerationshantering som problemtyp, anger det  prenumerations-ID som du vill överföra och väljer sedan Molnlösningsleverantör som supportplan. 
...
#### <a name="step-4-current-partner-completes-current-partner-fills-in-the-change-of-cloud-solution-provider-form"></a>Steg 4: Den aktuella partnern slutför den aktuella partnern i Molnlösningsleverantör formulär

Den aktuella partnern fyller [i Molnlösningsleverantör,](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RWwTWC)signerar det och skickar det till kunden.
...
- **Prenumerations-ID** som ska överföras (som du hittar i  menyn i Partnercenter genom att välja Kunder och sedan expandera kundens lista, välja **Visa** prenumerationer och sedan expandera den valda prenumerationen för att visa prenumerations-ID:t.

#### <a name="step-5-the-customer-and-new-partner-review--return-the-form"></a>Steg 5: Kunden och den nya partnergranskningen & returnera formuläret
...
#### <a name="step-6-current-partner-reviews-form-and-attaches-it-to-the-service-request"></a>Steg 6: Formuläret för aktuella partnergranskningar bifogas i tjänstbegäran
...
#### <a name="step-7-new-partner-removes-old-partner-from-account"></a>Steg 7: Ny partner tar bort den gamla partnern från kontot
...
> [!NOTE]
> Den första PowerShell-cmdleten kräver kundens **klientorganisations-ID**, som visas i Partnercenter som kundens **Microsoft-ID.** Följande procedur beskriver hur du hittar kundens Microsoft-ID (klient-ID) som ska användas i cmdleten .

**Så här hittar du en kunds Microsoft-ID (klientorganisations-ID) *för användning i Anslut-AzAccount* PowerShell-cmdlet:**
