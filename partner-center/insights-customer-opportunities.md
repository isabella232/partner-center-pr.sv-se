...
Följande skärmbild representerar de fyra SMB-undersegmenten. CloudAscent prioriterar profilering, bedömning och modellering av alla konton med högst och medelhög och ohanterad verksamhet.
...
1. Anpassa kundkonto
   ...
   - I bedömning av passningar används en modell av samma utseende som vår bästa SMB för att jämföra kunder och se om de är lämpliga för Microsoft Cloud Products.
...
Modeller för säljförsäljning använder transaktionsdata för att förutsäga potentialen för merförsäljning i Azure Microsoft 365 SKU:er.
