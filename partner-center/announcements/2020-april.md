...
- **Om du inte** har aktiverat de rekommenderade säkerhetskraven för att skydda din klientorganisation och användare måste du göra det omedelbart för att hålla dig kompatibel och undvika eventuella verksamhetsavbrott vid hantering av kunder eller transaktioner i CSP. Partner som inte implementerar säkerhetskraven kan riskera deras deltagande i CSP-programmet.
...
## <a name="new-opportunities-for-your-microsoft-365-education-customers-with-microsoft-365-a5-compliance"></a><a id="6"/></a>Nya möjligheter för dina Microsoft 365 Education med Microsoft 365 A5 efterlevnad
...
Den 1 april 2020 lade Microsoft till nytt värde för att Microsoft 365 A5 Compliance-erbjudanden utan prisändring. Det ytterligare värdet inkluderar
...
- Microsoft 365 A5 Efterlevnad för studenter | f0f9f37a-539f-4f44-aef6-e37070149499

### <a name="microsoft-365-a5-compliance-mini-suites"></a>Microsoft 365 A5 Minipaket för efterlevnad

Från och med 1 april 2020 kan Microsoft-partner också erbjuda följande minipaket. De här tilläggserbjudandena ger specifika delmängder av Microsoft 365 A5 för efterlevnad, vilket ger ytterligare möjligheter till kundtillväxt för specifika användningsfall och kundbehov.

- Microsoft 365 A5 Information Protection och styrning
- Microsoft 365 A5 Insider-riskhantering
- Microsoft 365 A5 eDiscovery och audit
...
**AIP-plan Office 365 Advanced Compliance Azure Information Protection (Sunsetting Office 365 Advanced Compliance) 2**

Förutom ändringarna ovan går Microsoft ned i Office 365 Advanced Compliance och Azure Information Protection (AIP) plan 2. Från och med 1 april 2020 är dessa erbjudanden inte längre tillgängliga i prislistan för nya nettokunder och automatisk förnyelse har inaktiverats för befintliga kunder.
...
Alla partner som gör en Molnlösningsleverantör -programmet (CSP).
