...
Microsoft har gjort det möjligt för befintliga kunder som är aktiva på sin EP att förnya sin EP via CSP-programmet och få Online-licenser för Dynamics 365 Business Central.
...
- En prispunkt som motsvarar ep-förnyelseofferten Dubbla användnings- och nedgraderingsrättigheter till deras aktuella lokala DPL-produkt (Dynamics 365 Business Central, lokalt, Dynamics NAV, Dynamics GP och Dynamics SL)
...
2. För Lösningsleverantörsavtal (SPA)-partner: Skicka ett ärende till [Operations](https://mbs2.microsoft.com/Support/OperationsIncidents.aspx?Mode=Create&t=1588193289962) för att lägga till EP till kundens konto. Ärenden för åtgärder kan skapas via PSBC. Följande ärendeinformation krävs:
   ...
   - Bekräftelse av kopia av CSP-beställning
