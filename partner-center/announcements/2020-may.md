...
## <a name="microsoft-365-a3--unattended-license-offer-for-education-correction"></a><a name="5"></a>Microsoft 365 A3 – Oövervakat licenserbjudande för education-korrigering
...
Följande prislista Microsoft 365 A3 – Obevakad licens för utbildning ingick i listan med förhandsversionspriser som publicerades den 1 maj 2020. Erbjudandet tas bort från prislistan den 1 augusti 2020.

- Produktfamilj: M365 A3 Unatnd License EDU
- Visningsnamn för erbjudande: M365 A3unattended License for students use benefit
...
Microsoft har gjort det möjligt för befintliga kunder som är aktiva på sin EP att förnya sin EP via CSP-programmet och ta emot Dynamics 365 Business Central-onlinelicenser.
...
- En prispunkt som är lika med EP-förnyelsen är dubbla användnings- och nedgraderingsrättigheter till deras aktuella lokala DPL-produkt (Dynamics 365 Business Central, lokalt, Dynamics NAV, Dynamics GP och Dynamics SL)
...
Observera att CSP-EP-förnyelseerbjudandet är ett nytt alternativ för kunder att förnya sin EP. Kunderna kommer att fortsätta att ha möjlighet att förnya sin EP per år via DPL för sin lokala lösning.

Dessa erbjudanden är tillgängliga i prislistan från den 1 juni 2020.

### <a name="customer-eligibility"></a>Kundberättigande

- **Licensieringskrav:** Kunder måste köpa Licenser för Dynamics 365 Business Central (moln) med en årlig totalsumma som är större än eller lika med deras förnyelsebelopp för EP.
- **Lägsta licenskrav:** Kunder måste uppfylla och upprätthålla licensieringskravet för sin CSP-prenumeration för att förhindra att en ep-ep upphör att gälla i DPL. De som antingen inte uppfyller behörighetskraven eller som avbryter sin CSP-prenumeration måste betala sina tidigare års EP-kostnader utöver avgiftsberättigade avgifter (som anges i customer [services and support policy)](https://mbs.microsoft.com/Files/partner/All_Products/Essentials/Agreements/CustomerServicesandSupportPolicyGuidePartnerVersion.pdf)för att fortsätta att få EP-förmåner för sin lokala DPL-lösning.
...
- **Erbjudandevaraktighet:** ett års första avtal och två valfria ettårsförnyelse (totalt tre år) eller en årsprenumeration med ett års alternativ för automatisk förnyelse
- **Erbjudandetillgänglighet:** Erbjudande beroende på [tillgänglighet för CSP-land](/dynamics365/business-central/dev-itpro/compliance/apptest-countries-and-translations)
- **Pris:** CSP-EP-förnyelseerbjudandet ger en prispunkt som är 60 % lägre än standardpriset för den kommersiella listan. Till exempel är CSP-EP-förnyelseerbjudandet listpris för Dynamics 365 Business Central (online) Premium-användare 40 USD jämfört med listpriset på 100 USD för CSP:s kommersiella standardprislista.
...
Partner måste säkerställa sina kunders fortsatt efterlevnad under året. Kunder som inte fortsätter att vara aktiva i CSP återgår till EP och ansvarar för alla åsysslade avgifter.
- **Ytterligare användare:** Kunder som uppfyller licensieringskravet och behöver ytterligare licenser för att täcka alla namngivna användare kan begära ytterligare användare. Licenser utan kostnad tillhandahålls via Microsoft Online-prenumerationsprogram kampanjkoder. När du löser in dessa koder måste kunderna ange ett kreditkort i identifieringssyfte, men kortet debiteras inte. Begäran om ytterligare användare måste göras inom 60 dagar från det första köpet av CSP-licensen.

### <a name="partner-discount"></a>Partnerrabatt

För den här befordran har Microsoft gett kundens partner ytterligare rabatt från partnerns nettopris. Microsoft kräver att Microsoft skickar vidare den ytterligare rabatten till kunden genom att minska Microsoft-produktens återförsäljningspris med ett belopp som är lika med eller större än rabatten. Anteckna följande:

- Partner får ingen marginal för de ytterligare användarlicenser som tillhandahålls utan kostnad.
- Nuvarande PartnerSource Business Center (PSBC)-partner måste välja bort sina kunder från autofakturering för att förhindra automatisk förnyelse av nästa års EP-plan.
...
1. Köp Dynamics 365 Business Central onlinetjänster SKU:er.
   ...
   |Dynamics 365 Business Central Essentials Cloud-tillägg från DPL|   8742366a-c26a-4bf0-86e8-6e2c72d9b919|Grundläggande för Dynamics 365 Business Central|
   ...
   |Teammedlemmar i Dynamics 365 Business Central Cloud-tillägg från DPL|   5d628802-49ce-4c84-954f-1a2170de1ac7|Teammedlemmar i Dynamics 365 Business Central|

2. För Lösningsleverantörsavtal (SPA)-partner: Skicka ett ärende [till Operations](https://mbs2.microsoft.com/Support/OperationsIncidents.aspx?Mode=Create&t=1588193289962) för att lägga till EP:n till kundens konto. Ärenden för åtgärder kan skapas via PSBC. Följande ärendeinformation krävs:

   - Kopia av CSP-orderbekräftelse
   - Kundens auktoriserade nummer, kontonummer eller TPID (Top Parent Identifier) som krävs för att identifiera rätt konto
...
- De som inte har migrerat helt till Dynamics 365 Business Central onlinetjänster kan, om de är berättigade, välja att fortsätta att förnya CSP-EP-förnyelseerbjudandet med ytterligare två år (totalt tre år).
...
- [Övergå till Microsoft Dynamics 365 Business Central](/dynamics365/business-central/dev-itpro/developer/readiness/readiness-transition-business-central)
...
Kontrollera alltid de senaste mallarna i Microsoft-portalerna eftersom de kan ha uppdaterats.

|**Tidigare kontaktinformation**|**Kontaktinformation gäller från den 15 maj 2020**|
|-------------------|:------|
...
Se till att alla system, kommunikationer och dokumentation uppdateras med den nya kontaktinformationen den 15 maj 2020.
...
## <a name="microsoft-is-ending-sales-of-the-microsoft-kaizala-pro-standalone-sku"></a><a id="2"/></a>Microsoft avslutar försäljningen av den fristående Microsoft Kaizala Pro SKU:n
...
Microsoft arbetar med att lägga till Kaizala Pro funktioner i Microsoft Teams, vilket i slutänden ersätter Microsoft Kaizala tjänsten. Du hittar information om de Kaizala som finns i Microsoft Teams [här](https://techcommunity.microsoft.com/t5/microsoft-kaizala-blog/update-on-kaizala-features-coming-to-microsoft-teams/ba-p/974525).
...
### <a name="kaizala-and-teams-will-continue-to-be-accessible-as-part-of-the-microsoft365-and-office365-skus-listed-below"></a>Kaizala och Teams kommer att fortsätta att vara tillgängliga som en del av SKU:erna för Microsoft365 och Office365 som anges nedan:
...
Nedan visas en lista över SKU:er som påverkas. Det kommer inte att ske någon ny försäljning av dessa SKU:er. Aktuella kunder kan stanna kvar på SKU:n och fortsätta att komma åt tjänsten och debiteras inte i nästa affärscykel.

|**Produktfamilj**|**SKU**|**Beskrivning**|**Program**|
|-------------------|:------|:-----|:---------|
|Microsoft Kaizala Pro (KAIZALA_STANDARD)|AAA-51195|Microsoft Kaizala Pro|CSP|
|Microsoft Kaizala Pro (KAIZALA_STANDARD)|AAA-51196|Microsoft Kaizala Pro (prissättning för myndigheter)|CSP|
|Microsoft Kaizala Pro (KAIZALA_STANDARD)|AAA-51191|Microsoft Kaizala Pro|Direct|
|Microsoft Kaizala Pro (KAIZALA_STANDARD)|AAA-51193|Microsoft Kaizala Pro (prissättning för myndigheter)|Direct|
|Microsoft Kaizala Pro (KAIZALA_STANDARD)|AAA-52249|Microsoft Kaizala Pro utvärderingsversion (government pricing)|Direct|
...
Partner som erbjuder Dynamics 365 via Molnlösningsleverantör (CSP) globalt (om inget annat anges).
