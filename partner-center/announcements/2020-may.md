...
Följande prislista Microsoft 365 A3 – Obevakat licenserbjudande för utbildning inkluderades i listan med förhandsversionspriser som publicerades den 1 maj 2020 med fel. Erbjudandet tas bort från prislistan den 1 augusti 2020.
...
- **Pris:** CSP-EP-förnyelseerbjudandet ger en prispunkt som är 60 % lägre än standardpriset för kommersiella listor. Till exempel är CSP-EP-förnyelseerbjudandet listpris för Dynamics 365 Business Central (online) Premium-användare $40 jämfört med listpriset på 100 USD för CSP:s kommersiella standardprislista.
...
- Nuvarande PartnerSource Business Center (PSBC) partner måste välja sina kunder från autofakturering för att förhindra automatisk förnyelse av nästa års EP-plan.
...
- De som inte har migrerat fullständigt till Dynamics 365 Business Central onlinetjänster kan, om de är berättigade, välja att fortsätta förnya CSP-EP-förnyelseerbjudandet med ytterligare två år (totalt tre år).
...
Microsoft arbetar med att lägga till Kaizala Pro funktioner i Microsoft Teams och ersätter slutligen Microsoft Kaizala tjänsten. Du hittar information om de Kaizala som finns i Microsoft Teams [här](https://techcommunity.microsoft.com/t5/microsoft-kaizala-blog/update-on-kaizala-features-coming-to-microsoft-teams/ba-p/974525).
...
Under tiden kan du lära dig mer om Microsoft365- och Office365-erbjudandena som Kaizala och Teams kommer att fortsätta att vara tillgängliga i på följande webbplatser: [Microsoft 365 for Business](https://www.microsoft.com/microsoft-365/compare-all-microsoft-365-products?&activetab=tab%3aprimaryr2), Microsoft 365 for [Enterprise](https://www.microsoft.com/microsoft-365/compare-microsoft-365-enterprise-plans), Microsoft 365 [for Education](https://www.microsoft.com/education/buy-license/microsoft365).

### <a name="questions"></a>Har du några frågor?

Kontakta [Partnercenter-supporten](https://partner.microsoft.com/dashboard/support/csp/servicerequests/create?category=csp) för frågor, frågor eller mer information.

_________________

## <a name="new-robotic-process-automation-rpa-offers-available-in-education-programs"></a><a id="1"/></a>Nya RPA-erbjudanden (Robotprocessautomatisering) är tillgängliga i Utbildningsprogram
...
Besök landningssidan om du vill [veta mer om RPA.](https://flow.microsoft.com/ui-flows/) Granska Dynamics [CSP-erbjudandeuppdateringar – maj 2020 för](https://partner.microsoft.com/resources/detail/dynamics365-csp-may-2020-offers-xlsx) ny SKU-information. Besök ändringarna [i Authorized Education-partnerprogrammet](https://partner.microsoft.com/resources/collection/csp-aer-partner-qualification-retirement#/) i CSP om du vill veta mer om ändringarna i Authorized Education-partnerprogrammet i CSP.
...
[FY20 PowerApps och Flow Licensing Updates](https://mbs.microsoft.com/partnersource/global/pricing-ordering/licensing-policies/Dyn365PricingandLicensing) 
 ...
 [Webbseminarserien FY20 Technical Readiness](https://learning.eventbuilder.com/FY20TechnicalReadinessWebinarSeries)
