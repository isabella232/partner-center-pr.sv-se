...
| Moldavien  | CEE        | MD               | 6, 7, 8 eller 13 siffror         | :::no-loc text="IDNO/IDNP"::: | Det unika id-numret (IDNO) som tilldelats den juridiska personen är också giltigt som skattekod. \"State Register of Law Units angående företag som är registrerade i Republiken Publicerade av Informations- och kommunikationsteknikavdelningen på myndighetsportalen för öppna data data.gov.md.\"                    |
