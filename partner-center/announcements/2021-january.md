...
- <span data-ttu-id="db5db-109">Datum: 2021-01-28</span><span class="sxs-lookup"><span data-stu-id="db5db-109">Date: 2021-01-28</span></span>
...
<span data-ttu-id="db5db-123">**Fas 2:**</span><span class="sxs-lookup"><span data-stu-id="db5db-123">**Phase 2:**</span></span>
...
### <a name="categories"></a><span data-ttu-id="db5db-148">Kategorier</span><span class="sxs-lookup"><span data-stu-id="db5db-148">Categories</span></span>
...
2. <span data-ttu-id="db5db-160">Partnern gör affärer med nya eller befintliga kunder i följande länder:</span><span class="sxs-lookup"><span data-stu-id="db5db-160">The partner does business with new or existing customers in the following countries:</span></span>
    ...
    - <span data-ttu-id="db5db-161">Thailand</span><span class="sxs-lookup"><span data-stu-id="db5db-161">Thailand</span></span>
...
- <span data-ttu-id="db5db-187">Ukraina</span><span class="sxs-lookup"><span data-stu-id="db5db-187">Ukraine</span></span>
...
<span data-ttu-id="db5db-201">17 december 2020: Ursprunglig publikation</span><span class="sxs-lookup"><span data-stu-id="db5db-201">December 17, 2020: Original publication</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="db5db-216">Nästa steg</span><span class="sxs-lookup"><span data-stu-id="db5db-216">Next steps</span></span>
...
<span data-ttu-id="db5db-226">Alla CSP-partner</span><span class="sxs-lookup"><span data-stu-id="db5db-226">All CSP partners</span></span>
...
### <a name="categories"></a><span data-ttu-id="db5db-239">Kategorier</span><span class="sxs-lookup"><span data-stu-id="db5db-239">Categories</span></span>
...
<span data-ttu-id="db5db-250">Den nya handelsupplevelsen ger följande fördelar:</span><span class="sxs-lookup"><span data-stu-id="db5db-250">The new commerce experience delivers the following benefits:</span></span>
...
- [<span data-ttu-id="db5db-289">Förstå partners intjänade kredit (guide)(microsoft.com)</span><span class="sxs-lookup"><span data-stu-id="db5db-289">Understanding Partner Earned Credit (Guide)(microsoft.com)</span></span>](https://partner.microsoft.com/resources/detail/understanding-partner-earned-credit-pdf)
...
- <span data-ttu-id="db5db-300">Datum: 2021-01-19</span><span class="sxs-lookup"><span data-stu-id="db5db-300">Date: 2021-01-19</span></span>
...
### <a name="categories"></a><span data-ttu-id="db5db-324">Kategorier</span><span class="sxs-lookup"><span data-stu-id="db5db-324">Categories</span></span>
...
- <span data-ttu-id="db5db-337">Begränsning säkerställer minimal avbrottstid.</span><span class="sxs-lookup"><span data-stu-id="db5db-337">Throttling ensures minimal downtime.</span></span>
...
|<span data-ttu-id="db5db-362">{baseURL}/v1/productUpgrades/{upgrade-id}/status</span><span class="sxs-lookup"><span data-stu-id="db5db-362">{baseURL}/v1/productUpgrades/{upgrade-id}/status</span></span>  | [<span data-ttu-id="db5db-363">Hämta status för produktuppgradering</span><span class="sxs-lookup"><span data-stu-id="db5db-363">Get product upgrade status</span></span>](/partner-center/develop/get-product-upgrade-status) |
...
<span data-ttu-id="db5db-377">Alla partner som gör en Molnlösningsleverantör via CSP-programmet</span><span class="sxs-lookup"><span data-stu-id="db5db-377">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>
...
2. <span data-ttu-id="db5db-447">Arbeta med IT-avdelningen för att:</span><span class="sxs-lookup"><span data-stu-id="db5db-447">Work with your IT department to:</span></span>
   - <span data-ttu-id="db5db-448">Lägg till e-postadressen i listan över säkra avsändare för att säkerställa att den inte ingår i någon adobesign@adobesign.com företablerad nätfiskeregel.</span><span class="sxs-lookup"><span data-stu-id="db5db-448">Add the adobesign@adobesign.com email address to their safe senders list to ensure that it’s not included in any pre-established phishing rule.</span></span>
   - <span data-ttu-id="db5db-449">Uppdatera befintliga säkerhetsprinciper för att säkerställa att alla mottagare som krävs kan signera dokumentation under din Adobe Sign Enterprise-licens.</span><span class="sxs-lookup"><span data-stu-id="db5db-449">Update existing security policies to ensure that all required recipients can sign documentation under your Adobe Sign enterprise license.</span></span>

<span data-ttu-id="db5db-450">Adobe Sign är Microsofts föredragna ESS (Electronic Signature Solution).</span><span class="sxs-lookup"><span data-stu-id="db5db-450">Adobe Sign is Microsoft’s preferred Electronic Signature Solution (ESS).</span></span> <span data-ttu-id="db5db-451">Övergången till Adobe Sign säkerställer en säker och effektiv elektronisk signaturupplevelse som ger större värde till våra kunder och partner.</span><span class="sxs-lookup"><span data-stu-id="db5db-451">The transition to Adobe Sign will ensure a secure and efficient electronic signature experience that will deliver greater value to our customers and partners.</span></span>

<span data-ttu-id="db5db-452">Mer information om hur du elektroniskt signerar dokument och elektronisk signaturdelegering finns i följande **självstudier:**</span><span class="sxs-lookup"><span data-stu-id="db5db-452">For additional information on how to electronically sign documents and electronic signature delegation, refer to the following **tutorials**:</span></span> 
- [<span data-ttu-id="db5db-453">Signera ett dokument på ett elektroniskt | Adobe Sign-självstudier</span><span class="sxs-lookup"><span data-stu-id="db5db-453">Electronically sign a document | Adobe Sign tutorials</span></span>](https://helpx.adobe.com/sign/how-to/adobe-for-signers.html?playlist=/ccx/v1/collection/product/sign/segment/designer/explevel/beginner/applaunch/continuinged/collection.ccx.js&ref=helpx.adobe.com)
- [<span data-ttu-id="db5db-454">Delegera någon annan att signera ett dokument | Adobe Sign-självstudier</span><span class="sxs-lookup"><span data-stu-id="db5db-454">Delegate someone else to sign a document | Adobe Sign tutorials</span></span>](https://helpx.adobe.com/sign/how-to/use-the-delegator-role.html?playlist=/ccx/v1/collection/product/sign/segment/designer/explevel/beginner/applaunch/orientation/collection.ccx.js&ref=helpx.adobe.com)

### <a name="next-steps"></a><span data-ttu-id="db5db-455">Nästa steg</span><span class="sxs-lookup"><span data-stu-id="db5db-455">Next steps</span></span>

<span data-ttu-id="db5db-456">Dela den här informationen med lämpliga intressenter i din organisation.</span><span class="sxs-lookup"><span data-stu-id="db5db-456">Share this information with the appropriate stakeholders in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="db5db-457">Har du några frågor?</span><span class="sxs-lookup"><span data-stu-id="db5db-457">Questions?</span></span>

<span data-ttu-id="db5db-458">Om du har några frågor kan du kontakta Regionalt driftcenter med hjälp av [Call Logging Tool (CLT)](https://clt.partners.extranet.microsoft.com/CLT) eller [utforska MS](https://www.explore.ms/).</span><span class="sxs-lookup"><span data-stu-id="db5db-458">If you have any questions, contact your Regional Operations Center using the [Call Logging Tool (CLT)](https://clt.partners.extranet.microsoft.com/CLT) or at [Explore MS](https://www.explore.ms/).</span></span> <span data-ttu-id="db5db-459">Följ CLT-standardprocessen noggrant så att vi kan lösa din fråga så snabbt som möjligt.</span><span class="sxs-lookup"><span data-stu-id="db5db-459">Follow the standard CLT process closely so that we can resolve your query as quickly as possible.</span></span>

_____________ 

## <a name="commercial-pricing-update-for-norwegian-krone"></a><a name="6"></a><span data-ttu-id="db5db-460">Kommersiell prisuppdatering för norska kronor</span><span class="sxs-lookup"><span data-stu-id="db5db-460">Commercial pricing update for Norwegian krone</span></span> 

### <a name="categories"></a><span data-ttu-id="db5db-461">Kategorier</span><span class="sxs-lookup"><span data-stu-id="db5db-461">Categories</span></span>

- <span data-ttu-id="db5db-462">Datum: 2021-01-14</span><span class="sxs-lookup"><span data-stu-id="db5db-462">Date: 2021-01-14</span></span>
- <span data-ttu-id="db5db-463">Erbjudanden/marknader</span><span class="sxs-lookup"><span data-stu-id="db5db-463">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="db5db-464">Påverkad målgrupp</span><span class="sxs-lookup"><span data-stu-id="db5db-464">Impacted audience</span></span>

<span data-ttu-id="db5db-465">Molnlösningsleverantör partner som använder den norska kronorn.</span><span class="sxs-lookup"><span data-stu-id="db5db-465">Cloud Solution Provider partners using the Norwegian krone.</span></span>

### <a name="details"></a><span data-ttu-id="db5db-466">Information</span><span class="sxs-lookup"><span data-stu-id="db5db-466">Details</span></span>

<span data-ttu-id="db5db-467">Från den 1 mars 2021 ändras de norska kronorna för kommersiella lokala programvaror och onlinetjänster till att justeras enligt gällande prisnivåer i regionen.</span><span class="sxs-lookup"><span data-stu-id="db5db-467">From March 1, 2021, Norwegian krone prices for commercial on-premises software and online services will change to realign with prevailing pricing levels in the region.</span></span>
<span data-ttu-id="db5db-468">Det fullständiga meddelandet är endast tillgängligt för Microsoft-partner.</span><span class="sxs-lookup"><span data-stu-id="db5db-468">The full announcement is available only to Microsoft partners.</span></span> <span data-ttu-id="db5db-469">[Logga in för att få åtkomst till det fullständiga meddelandet](https://partner.microsoft.com/resources/detail/pricing-update-norway-partners-pdf).</span><span class="sxs-lookup"><span data-stu-id="db5db-469">[Sign in to access the full announcement](https://partner.microsoft.com/resources/detail/pricing-update-norway-partners-pdf).</span></span>

_____________ 

## <a name="commercial-pricing-update-for-the-indian-rupee"></a><a name="5"></a><span data-ttu-id="db5db-470">Kommersiell prisuppdatering för rupier i Indien</span><span class="sxs-lookup"><span data-stu-id="db5db-470">Commercial pricing update for the Indian rupee</span></span> 

### <a name="categories"></a><span data-ttu-id="db5db-471">Kategorier</span><span class="sxs-lookup"><span data-stu-id="db5db-471">Categories</span></span>

- <span data-ttu-id="db5db-472">Datum: 2021-01-08</span><span class="sxs-lookup"><span data-stu-id="db5db-472">Date: 2021-01-08</span></span>
- <span data-ttu-id="db5db-473">Erbjudanden/marknader</span><span class="sxs-lookup"><span data-stu-id="db5db-473">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="db5db-474">Påverkad målgrupp</span><span class="sxs-lookup"><span data-stu-id="db5db-474">Impacted audience</span></span>

<span data-ttu-id="db5db-475">CSP-partner som gör en överträdelse i Indien.</span><span class="sxs-lookup"><span data-stu-id="db5db-475">CSP partners transacting in India.</span></span>

### <a name="details"></a><span data-ttu-id="db5db-476">Information</span><span class="sxs-lookup"><span data-stu-id="db5db-476">Details</span></span> 

<span data-ttu-id="db5db-477">Microsoft gör ändringar i den japanska rupiers prislista för att justera priserna för kommersiell programvara och onlinetjänster i Indien och Asien.</span><span class="sxs-lookup"><span data-stu-id="db5db-477">Microsoft is making changes to the Indian rupee price list to align prices for commercial software and online services within India and the Asian region.</span></span> <span data-ttu-id="db5db-478">Vi publicerar mer information när de blir tillgängliga.</span><span class="sxs-lookup"><span data-stu-id="db5db-478">We'll publish more details as they become available.</span></span> <span data-ttu-id="db5db-479">Om du behöver hjälp under tiden kontaktar du [Support för Partnercenter.](https://partner.microsoft.com/support/?stage=1)</span><span class="sxs-lookup"><span data-stu-id="db5db-479">If you need help in the meantime, contact [Partner Center support](https://partner.microsoft.com/support/?stage=1).</span></span>

________________

## <a name="calling-plan-and-phone-system-updates-for-february-1-2021"></a><a name="4"></a><span data-ttu-id="db5db-480">Anropsplan Telefonsystem uppdateringar för 1 februari 2021</span><span class="sxs-lookup"><span data-stu-id="db5db-480">Calling Plan and Phone System updates for February 1, 2021</span></span>

### <a name="categories"></a><span data-ttu-id="db5db-481">Kategorier</span><span class="sxs-lookup"><span data-stu-id="db5db-481">Categories</span></span>

- <span data-ttu-id="db5db-482">Datum: 2021-01-08</span><span class="sxs-lookup"><span data-stu-id="db5db-482">Date: 2021-01-08</span></span>
- <span data-ttu-id="db5db-483">Erbjudanden/marknader</span><span class="sxs-lookup"><span data-stu-id="db5db-483">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="db5db-484">Sammanfattning</span><span class="sxs-lookup"><span data-stu-id="db5db-484">Summary</span></span>

<span data-ttu-id="db5db-485">Ett tilläggsprogram för Microsoft 365, som omfattar Telefonsystem och nationella samtalsplan och en fristående plan för nationella samtal, kommer snart att välja länder.</span><span class="sxs-lookup"><span data-stu-id="db5db-485">An add-on offer to Microsoft 365, which will include Phone System and Domestic Calling Plan and a standalone Domestic Calling Plan, is coming soon to select countries.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="db5db-486">Påverkad målgrupp</span><span class="sxs-lookup"><span data-stu-id="db5db-486">Impacted audience</span></span>

<span data-ttu-id="db5db-487">Alla partner som gör en transact genom Molnlösningsleverantör(CSP)-programmet.</span><span class="sxs-lookup"><span data-stu-id="db5db-487">All partners transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="db5db-488">Information</span><span class="sxs-lookup"><span data-stu-id="db5db-488">Details</span></span> 

<span data-ttu-id="db5db-489">Det paketerade erbjudandet för tillägg till Microsoft 365 E1-, E3- och E5-erbjudanden omfattar Telefonsystem och nationella samtalsplan.</span><span class="sxs-lookup"><span data-stu-id="db5db-489">The add-on bundled offer to Microsoft 365 E1, E3, and E5 offers will include Phone System and Domestic Calling Plan.</span></span> <span data-ttu-id="db5db-490">Dessutom kommer ett nytt fristående erbjudande för nationella samtalsplan att vara tillgängligt endast för E5.</span><span class="sxs-lookup"><span data-stu-id="db5db-490">In addition, a new standalone Domestic Calling Plan offer will be available for E5 only.</span></span> <span data-ttu-id="db5db-491">De nya erbjudandena kommer endast att vara tillgängliga för kunder i USA, Puerto Toronto och Kanada. För alla andra länder och territorier förblir de befintliga globala fristående SKU:erna och priserna desamma.</span><span class="sxs-lookup"><span data-stu-id="db5db-491">The new offers will be available to customers in the US, Puerto Rico, and Canada only; for all other countries and territories, the existing global standalone SKUs and pricing remain the same.</span></span> 

<span data-ttu-id="db5db-492">Dessa erbjudanden kommer att vara tillgängliga för kommersiella kunder, studenter, lärare, Government Community Cloud (GCC) och ideella kunder i USA, Puerto Toronto och Kanada.</span><span class="sxs-lookup"><span data-stu-id="db5db-492">These offers will be available to Commercial, Student, Faculty, Government Community Cloud (GCC), and Nonprofit customers in the US, Puerto Rico, and Canada.</span></span> <span data-ttu-id="db5db-493">Anropsplaner är inte tillgängliga i något av de andra områdena i USA.</span><span class="sxs-lookup"><span data-stu-id="db5db-493">Calling plans are not available in any of the other US territories.</span></span>

   |<span data-ttu-id="db5db-494">**Erbjudandets namn**</span><span class="sxs-lookup"><span data-stu-id="db5db-494">**Offer name**</span></span>|<span data-ttu-id="db5db-495">**Erbjudande-ID**</span><span class="sxs-lookup"><span data-stu-id="db5db-495">**Offer ID**</span></span>|<span data-ttu-id="db5db-496">**Material-ID**</span><span class="sxs-lookup"><span data-stu-id="db5db-496">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="db5db-497">Microsoft Teams Anropa Essentials för USA och Kanada</span><span class="sxs-lookup"><span data-stu-id="db5db-497">Microsoft Teams Calling Essentials for US and Canada</span></span>|<span data-ttu-id="db5db-498">1ee81de6-4d8b-4cf1-b926-2fd2a774a4ca</span><span class="sxs-lookup"><span data-stu-id="db5db-498">1ee81de6-4d8b-4cf1-b926-2fd2a774a4ca</span></span>|<span data-ttu-id="db5db-499">8N2-00010</span><span class="sxs-lookup"><span data-stu-id="db5db-499">8N2-00010</span></span>|
   |<span data-ttu-id="db5db-500">Microsoft Teams Calling Essentials för USA och Kanada (prissättning för ideell personal)</span><span class="sxs-lookup"><span data-stu-id="db5db-500">Microsoft Teams Calling Essentials for US and Canada (Nonprofit Staff Pricing)</span></span>|<span data-ttu-id="db5db-501">0c2ece0d-39b7-40ec-8c08-87c2b6c75d62</span><span class="sxs-lookup"><span data-stu-id="db5db-501">0c2ece0d-39b7-40ec-8c08-87c2b6c75d62</span></span>|<span data-ttu-id="db5db-502">8N2-00011</span><span class="sxs-lookup"><span data-stu-id="db5db-502">8N2-00011</span></span>|
   |<span data-ttu-id="db5db-503">Microsoft Teams Anropa Essentials för USA och Kanada för lärare och lärare</span><span class="sxs-lookup"><span data-stu-id="db5db-503">Microsoft Teams Calling Essentials for US and Canada for faculty</span></span>|<span data-ttu-id="db5db-504">b8baa3b8-8cc2-4f26-a212-7fbeb28e7895</span><span class="sxs-lookup"><span data-stu-id="db5db-504">b8baa3b8-8cc2-4f26-a212-7fbeb28e7895</span></span>|<span data-ttu-id="db5db-505">8N3-00003</span><span class="sxs-lookup"><span data-stu-id="db5db-505">8N3-00003</span></span>|
   |<span data-ttu-id="db5db-506">Microsoft Teams Anropa Essentials för USA och Kanada för studenter</span><span class="sxs-lookup"><span data-stu-id="db5db-506">Microsoft Teams Calling Essentials for US and Canada for students</span></span>|<span data-ttu-id="db5db-507">26956da8-eeb5-44e3-aa79-d36e0e42b930</span><span class="sxs-lookup"><span data-stu-id="db5db-507">26956da8-eeb5-44e3-aa79-d36e0e42b930</span></span>|<span data-ttu-id="db5db-508">8N3-00004</span><span class="sxs-lookup"><span data-stu-id="db5db-508">8N3-00004</span></span>|
   |<span data-ttu-id="db5db-509">Microsoft Teams Anropa Essentials för USA och Kanada för GCC</span><span class="sxs-lookup"><span data-stu-id="db5db-509">Microsoft Teams Calling Essentials for US and Canada for GCC</span></span>|<span data-ttu-id="db5db-510">7a2e2d5a-41b5-4b20-a0d1-0d06d34b5fe1</span><span class="sxs-lookup"><span data-stu-id="db5db-510">7a2e2d5a-41b5-4b20-a0d1-0d06d34b5fe1</span></span>|<span data-ttu-id="db5db-511">8N4-00002</span><span class="sxs-lookup"><span data-stu-id="db5db-511">8N4-00002</span></span>|
   |<span data-ttu-id="db5db-512">Microsoft 365 Plan för nationella samtal för USA och Kanada</span><span class="sxs-lookup"><span data-stu-id="db5db-512">Microsoft 365 Domestic Calling Plan for US and Canada</span></span>|<span data-ttu-id="db5db-513">60d2919e-427a-46c9-bd03-89cbad27d53f</span><span class="sxs-lookup"><span data-stu-id="db5db-513">60d2919e-427a-46c9-bd03-89cbad27d53f</span></span>|<span data-ttu-id="db5db-514">TK2-00050</span><span class="sxs-lookup"><span data-stu-id="db5db-514">TK2-00050</span></span>|
   |<span data-ttu-id="db5db-515">Microsoft 365 Nationella samtalsplan för lärare och lärare för USA och Kanada</span><span class="sxs-lookup"><span data-stu-id="db5db-515">Microsoft 365 Domestic Calling Plan for faculty for US and Canada</span></span>|<span data-ttu-id="db5db-516">602e7548-375b-4e01-bf79-a9a8b8ff16d4</span><span class="sxs-lookup"><span data-stu-id="db5db-516">602e7548-375b-4e01-bf79-a9a8b8ff16d4</span></span>|<span data-ttu-id="db5db-517">LM7-00006</span><span class="sxs-lookup"><span data-stu-id="db5db-517">LM7-00006</span></span>|
   |<span data-ttu-id="db5db-518">Microsoft 365 Plan för nationella samtal för studenter för USA och Kanada</span><span class="sxs-lookup"><span data-stu-id="db5db-518">Microsoft 365 Domestic Calling Plan for students for US and Canada</span></span>|<span data-ttu-id="db5db-519">1f4b4375-3185-40cf-b044-117fe3b102c6</span><span class="sxs-lookup"><span data-stu-id="db5db-519">1f4b4375-3185-40cf-b044-117fe3b102c6</span></span>|<span data-ttu-id="db5db-520">LM7-00007</span><span class="sxs-lookup"><span data-stu-id="db5db-520">LM7-00007</span></span>|
   |<span data-ttu-id="db5db-521">Microsoft 365 Nationella samtalsplan för GCC för USA och Kanada</span><span class="sxs-lookup"><span data-stu-id="db5db-521">Microsoft 365 Domestic Calling Plan for GCC for US and Canada</span></span>|<span data-ttu-id="db5db-522">594ed84e-ddf8-4e40-9726-76c04bd29e3b</span><span class="sxs-lookup"><span data-stu-id="db5db-522">594ed84e-ddf8-4e40-9726-76c04bd29e3b</span></span>|<span data-ttu-id="db5db-523">LM9-00023</span><span class="sxs-lookup"><span data-stu-id="db5db-523">LM9-00023</span></span>|

### <a name="next-steps"></a><span data-ttu-id="db5db-524">Nästa steg</span><span class="sxs-lookup"><span data-stu-id="db5db-524">Next steps</span></span>

- <span data-ttu-id="db5db-525">Dela den här informationen med relevanta kontakter i din organisation och förstå möjligheter till merförsäljning och korsförsäljning.</span><span class="sxs-lookup"><span data-stu-id="db5db-525">Share this information with the relevant contacts in your organization and understand the upsell and cross-sell opportunities.</span></span> 
- <span data-ttu-id="db5db-526">Läs avsnittet resurser i Teams [partnerguide.](https://aka.ms/teamscallingmeetingsguide)</span><span class="sxs-lookup"><span data-stu-id="db5db-526">Review the resources section of the [Teams Partner Guide](https://aka.ms/teamscallingmeetingsguide).</span></span>

_____________ 

## <a name="license-base-price-list-updates-for-january-2021"></a><a name="3"></a><span data-ttu-id="db5db-527">Uppdateringar av prislistan för licensbas för januari 2021</span><span class="sxs-lookup"><span data-stu-id="db5db-527">License-base price list updates for January 2021</span></span> 

### <a name="categories"></a><span data-ttu-id="db5db-528">Kategorier</span><span class="sxs-lookup"><span data-stu-id="db5db-528">Categories</span></span>

- <span data-ttu-id="db5db-529">Datum: 2021-01-08</span><span class="sxs-lookup"><span data-stu-id="db5db-529">Date: 2021-01-08</span></span>
- <span data-ttu-id="db5db-530">Erbjudanden/marknader</span><span class="sxs-lookup"><span data-stu-id="db5db-530">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="db5db-531">Sammanfattning</span><span class="sxs-lookup"><span data-stu-id="db5db-531">Summary</span></span>

<span data-ttu-id="db5db-532">Prislistorna januari och februari för licensbaserade erbjudanden har uppdaterats för att korrigera vissa felaktiga listpriser.</span><span class="sxs-lookup"><span data-stu-id="db5db-532">January and February price lists for license-based offers have been updated to correct certain incorrect list prices.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="db5db-533">Påverkad målgrupp</span><span class="sxs-lookup"><span data-stu-id="db5db-533">Impacted audience</span></span>

<span data-ttu-id="db5db-534">Alla partner som gör en transact genom Molnlösningsleverantör(CSP)-programmet.</span><span class="sxs-lookup"><span data-stu-id="db5db-534">All partners transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="db5db-535">Information</span><span class="sxs-lookup"><span data-stu-id="db5db-535">Details</span></span> 

<span data-ttu-id="db5db-536">De licensbaserade prislistorna för januari 2021 och februari 2021 innehåller några felaktiga listpriser.</span><span class="sxs-lookup"><span data-stu-id="db5db-536">The license-based price lists for January 2021 and February 2021 included a few incorrect list prices.</span></span> <span data-ttu-id="db5db-537">De erbjudanden och valutor som påverkas visas nedan.</span><span class="sxs-lookup"><span data-stu-id="db5db-537">The impacted offers and currencies are below.</span></span> <span data-ttu-id="db5db-538">Rätt priser har uppdaterats och är tillgängliga från och med 7 januari 2021 14:00 PST (Pacific Standard Time).</span><span class="sxs-lookup"><span data-stu-id="db5db-538">The correct pricing was updated and available as of January 7, 2021 2PM PST (Pacific Standard Time).</span></span> 

   |<span data-ttu-id="db5db-539">**Erbjudandets namn**</span><span class="sxs-lookup"><span data-stu-id="db5db-539">**Offer name**</span></span>|<span data-ttu-id="db5db-540">**Erbjudande-ID**</span><span class="sxs-lookup"><span data-stu-id="db5db-540">**Offer ID**</span></span>|<span data-ttu-id="db5db-541">**Material-ID**</span><span class="sxs-lookup"><span data-stu-id="db5db-541">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="db5db-542">Microsoft 365 E3</span><span class="sxs-lookup"><span data-stu-id="db5db-542">Microsoft 365 E3</span></span>|<span data-ttu-id="db5db-543">2b3b8d2d-10aa-4be4-b5fd-7f2feb0c3091</span><span class="sxs-lookup"><span data-stu-id="db5db-543">2b3b8d2d-10aa-4be4-b5fd-7f2feb0c3091</span></span>|<span data-ttu-id="db5db-544">AAA-35638</span><span class="sxs-lookup"><span data-stu-id="db5db-544">AAA-35638</span></span>| 
   |<span data-ttu-id="db5db-545">Microsoft 365 Business Basic</span><span class="sxs-lookup"><span data-stu-id="db5db-545">Microsoft 365 Business Basic</span></span>|<span data-ttu-id="db5db-546">bd938f12-058f-4927-bba3-ae36b1d2501c</span><span class="sxs-lookup"><span data-stu-id="db5db-546">bd938f12-058f-4927-bba3-ae36b1d2501c</span></span>|<span data-ttu-id="db5db-547">AAA-10624</span><span class="sxs-lookup"><span data-stu-id="db5db-547">AAA-10624</span></span>|

<span data-ttu-id="db5db-548">Valutor som påverkas:</span><span class="sxs-lookup"><span data-stu-id="db5db-548">Currencies impacted:</span></span> 

- <span data-ttu-id="db5db-549">Microsoft 365 E3 prisproblem begränsades till endast dessa valutor: japanska dollar (JPY), brittiska pund (GBP), EU (EUR), australiensiska dollar (AUD).</span><span class="sxs-lookup"><span data-stu-id="db5db-549">Microsoft 365 E3 price issues were limited to only these currencies: Japanese Yen (JPY), Great British Pound (GBP), European Union (EUR), Australian Dollar (AUD).</span></span> 
- <span data-ttu-id="db5db-550">Microsoft 365 Business Basic problem begränsades till endast USA dollar (USD).</span><span class="sxs-lookup"><span data-stu-id="db5db-550">Microsoft 365 Business Basic issues were limited to only United States Dollars (USD).</span></span> 

<span data-ttu-id="db5db-551">Partner bör referera till de prislistor för förhandsversionen av januari och februari som är tillgängliga för att hitta rätt priser.</span><span class="sxs-lookup"><span data-stu-id="db5db-551">Partners should reference the currently available January and February preview price lists for the correct prices.</span></span> 

### <a name="next-steps"></a><span data-ttu-id="db5db-552">Nästa steg</span><span class="sxs-lookup"><span data-stu-id="db5db-552">Next steps</span></span>

- <span data-ttu-id="db5db-553">Partner bör ladda ned de senaste prislistefilerna från Partnercenter för att hämta de korrigerade priserna för januari och februari.</span><span class="sxs-lookup"><span data-stu-id="db5db-553">Partners should download the latest price list files from the Partner Center to get the corrected January and February prices.</span></span> 
- <span data-ttu-id="db5db-554">Globala administratörer för påverkade klienter som har köpt prenumerationer mellan 1 januari och 6 januari meddelas via e-post i Partnercenter före slutet av januari med mer information.</span><span class="sxs-lookup"><span data-stu-id="db5db-554">Global administrators for impacted tenants who have purchased subscriptions between January 1 and January 6 will be notified via a Partner Center email before the end of January with more details.</span></span> 

________________
## <a name="deprecation-and-retirement-of-existing-get-and-put-qualification-apis-for-the-education-customer-validation-process-by-the-end-of-february-2021"></a><a name="2"></a><span data-ttu-id="db5db-555">Utfasning och tillbakadragning av befintliga GET- och PUT-kvalificerings-API:er för kundvalideringsprocessen för Education i slutet av februari 2021</span><span class="sxs-lookup"><span data-stu-id="db5db-555">Deprecation and retirement of existing GET and PUT Qualification APIs for the Education customer validation process by the end of February 2021</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="db5db-556">Påverkad målgrupp</span><span class="sxs-lookup"><span data-stu-id="db5db-556">Impacted audience</span></span>

<span data-ttu-id="db5db-557">Partner som säljer Academic-erbjudanden via Molnlösningsleverantör med partnercenter-API:et</span><span class="sxs-lookup"><span data-stu-id="db5db-557">Partners selling Academic offers through the Cloud Solution Provider program using the Partner Center API</span></span>

### <a name="details"></a><span data-ttu-id="db5db-558">Information</span><span class="sxs-lookup"><span data-stu-id="db5db-558">Details</span></span> 

<span data-ttu-id="db5db-559">Det här är en uppföljning av de API-förbättringar som släpptes i december 2020.</span><span class="sxs-lookup"><span data-stu-id="db5db-559">This is a follow-up to the API enhancements released in December 2020.</span></span> <span data-ttu-id="db5db-560">I december 2020 släpptes nya GET- och POST-kvalificerings-API:er, och därför kommer de gamla GET- och PUT-kvalificerings-API:erna att dras tillbaka i slutet av februari 2021.</span><span class="sxs-lookup"><span data-stu-id="db5db-560">In December 2020 new GET and POST Qualifications APIs were released, and as a result the old GET and PUT Qualification APIs will be retired by the end of February 2021.</span></span> <span data-ttu-id="db5db-561">Då måste du använda de nya GET- och POST Partner Center-API:erna för att kunna köpa Education-erbjudanden.</span><span class="sxs-lookup"><span data-stu-id="db5db-561">At that time, you will need to use the new GET and POST Partner Center APIs in order to be able to purchase Education offers.</span></span> 

### <a name="next-steps"></a><span data-ttu-id="db5db-562">Nästa steg</span><span class="sxs-lookup"><span data-stu-id="db5db-562">Next steps</span></span>

- <span data-ttu-id="db5db-563">Om du inte redan har gjort det uppdaterar du till de nya API:erna för en lyckad övergång i rätt tid.</span><span class="sxs-lookup"><span data-stu-id="db5db-563">If you haven't already done so, update to the new APIs for a successful and timely transition.</span></span>
- <span data-ttu-id="db5db-564">Granska de nya partnercenter-API-ändringarna och guide i resurserna för driftberedskap: Förbättringar av [kundvalideringsprocessen i Partnercenter Education.](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)</span><span class="sxs-lookup"><span data-stu-id="db5db-564">Review the new Partner Center API changes, and [Guide in the Operations Readiness resources:  Partner Center Education customer validation process enhancements](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/).</span></span>
- <span data-ttu-id="db5db-565">Dela den här informationen med lämpliga team i din organisation och med dina återförsäljare för att hjälpa dem att förbereda sig för dessa ändringar.</span><span class="sxs-lookup"><span data-stu-id="db5db-565">Share this information with the appropriate teams in your organization, and with your resellers, to help them prepare for these changes.</span></span>

_____________

## <a name="dynamics-365-offers-for-february-2021"></a><a name="1"></a><span data-ttu-id="db5db-566">Dynamics 365-erbjudanden för februari 2021</span><span class="sxs-lookup"><span data-stu-id="db5db-566">Dynamics 365 offers for February 2021</span></span>

### <a name="categories"></a><span data-ttu-id="db5db-567">Kategorier</span><span class="sxs-lookup"><span data-stu-id="db5db-567">Categories</span></span>

- <span data-ttu-id="db5db-568">Datum: 2021-01-04</span><span class="sxs-lookup"><span data-stu-id="db5db-568">Date: 2021-01-04</span></span>
- <span data-ttu-id="db5db-569">Erbjudanden</span><span class="sxs-lookup"><span data-stu-id="db5db-569">Offers</span></span>

### <a name="summary"></a><span data-ttu-id="db5db-570">Sammanfattning</span><span class="sxs-lookup"><span data-stu-id="db5db-570">Summary</span></span>

<span data-ttu-id="db5db-571">Nya dynamics 365-erbjudandeändringar kommer att lanseras i februari 2021.</span><span class="sxs-lookup"><span data-stu-id="db5db-571">New Dynamics 365 offer changes will be launched in February 2021.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="db5db-572">Påverkad målgrupp</span><span class="sxs-lookup"><span data-stu-id="db5db-572">Impacted audience</span></span>

<span data-ttu-id="db5db-573">Partner som deltar i Molnlösningsleverantör(CSP) partner för direktfakturering, indirekt leverantör och indirekta incitamentprogram för återförsäljare</span><span class="sxs-lookup"><span data-stu-id="db5db-573">Partners participating in the Cloud Solution Provider (CSP) direct bill partner, indirect provider, and indirect reseller incentive programs</span></span>

### <a name="details"></a><span data-ttu-id="db5db-574">Information</span><span class="sxs-lookup"><span data-stu-id="db5db-574">Details</span></span>

<span data-ttu-id="db5db-575">Microsoft presenterar kommande nya Dynamics 365-erbjudandeändringar som kommer att lanseras i februari 2021 för:</span><span class="sxs-lookup"><span data-stu-id="db5db-575">Microsoft is announcing upcoming new Dynamics 365 offer changes that will be launched in February 2021 for:</span></span>

- <span data-ttu-id="db5db-576">Dynamics 365 Customer Voice – ytterligare svar</span><span class="sxs-lookup"><span data-stu-id="db5db-576">Dynamics 365 Customer Voice Additional Response</span></span>
- <span data-ttu-id="db5db-577">Dynamics 365 Customer Service Insights end of life</span><span class="sxs-lookup"><span data-stu-id="db5db-577">Dynamics 365 Customer Service Insights End of Life</span></span>
- <span data-ttu-id="db5db-578">Ändring av Erbjudande-ID:er för Dynamics 365 Cloud AX-migrering</span><span class="sxs-lookup"><span data-stu-id="db5db-578">Dynamics 365 Cloud AX Migration Offer IDs change</span></span>

<span data-ttu-id="db5db-579">**Dynamics 365 Customer Voice – ytterligare svar**</span><span class="sxs-lookup"><span data-stu-id="db5db-579">**Dynamics 365 Customer Voice Additional Response**</span></span>

<span data-ttu-id="db5db-580">Den 1 februari 2021 skapar Microsoft ett nytt erbjudande om "Ytterligare svar" med 1 K svarsberättigande för att ersätta det befintliga erbjudandet med 2 K Undersökningssvar, där försäljningen avslutas den 1 februari 2021.</span><span class="sxs-lookup"><span data-stu-id="db5db-580">On February 1, 2021, Microsoft will create a new "Additional Response" offer with 1-K response entitlement to replace the existing offer with 2-K Survey Responses, the end of sale of which will be on February 1, 2021.</span></span>

<span data-ttu-id="db5db-581">Se fliken "Customer Voice Addl Resp" i [dokumentet Dynamics CSP Offers-February 2021 Excel](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) för information om SKU:n.</span><span class="sxs-lookup"><span data-stu-id="db5db-581">See the "Customer Voice Addl Resp" tab in the [Dynamics CSP Offers-February 2021 Excel document](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) for the SKU details.</span></span> <span data-ttu-id="db5db-582">Mer information finns på startsidan [för Microsoft Dynamics 365 Customer Voice.](https://dynamics.microsoft.com/customer-voice/overview/)</span><span class="sxs-lookup"><span data-stu-id="db5db-582">View the [Microsoft Dynamics 365 Customer Voice Home Page](https://dynamics.microsoft.com/customer-voice/overview/) for more information.</span></span>

<span data-ttu-id="db5db-583">**Dynamics 365 Customer Service Insights end of life**</span><span class="sxs-lookup"><span data-stu-id="db5db-583">**Dynamics 365 Customer Service Insights End of Life**</span></span>

<span data-ttu-id="db5db-584">Den 1 februari 2021 ändras följande produkter till livscykeln:</span><span class="sxs-lookup"><span data-stu-id="db5db-584">On February 1, 2021, the following products will be changed to end-of-life:</span></span>

- <span data-ttu-id="db5db-585">Dynamics 365 Customer Service Insights (inklusive "Ytterligare ärenden")</span><span class="sxs-lookup"><span data-stu-id="db5db-585">Dynamics 365 Customer Service Insights (including "Additional Cases")</span></span>
- <span data-ttu-id="db5db-586">Dynamics 365 Virtual Agent for Customer Service</span><span class="sxs-lookup"><span data-stu-id="db5db-586">Dynamics 365 Virtual Agent for Customer Service</span></span>

<span data-ttu-id="db5db-587">Den fristående upplevelsen "Customer Service Insights" flyttar till "Dynamics 365 Customer Service", där kunderna kan hitta samma funktioner som är djupt inbäddade i kundtjänstupplevelserna.</span><span class="sxs-lookup"><span data-stu-id="db5db-587">The "Customer Service Insights" standalone experience is moving into "Dynamics 365 Customer Service", where customers can find the same capabilities deeply embedded in the customer service experiences.</span></span>  

<span data-ttu-id="db5db-588">Se fliken Customer Service Insights i [dokumentet Dynamics CSP Offers-February 2021 Excel](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) för information om SKU:n.</span><span class="sxs-lookup"><span data-stu-id="db5db-588">See the "Customer Service Insights" tab in the [Dynamics CSP Offers-February 2021 Excel document](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) for the SKU details.</span></span> <span data-ttu-id="db5db-589">Besök [startsidan för Microsoft Dynamics-kundtjänst för](https://dynamics.microsoft.com/customer-service/overview/) mer information.</span><span class="sxs-lookup"><span data-stu-id="db5db-589">Visit the [Microsoft Dynamics Customer Service Home Page](https://dynamics.microsoft.com/customer-service/overview/) for more information.</span></span>

<span data-ttu-id="db5db-590">**Erbjudande-ID:er för Dynamics 365 Cloud AX-migrering**</span><span class="sxs-lookup"><span data-stu-id="db5db-590">**Dynamics 365 Cloud AX migration offer IDs**</span></span>

<span data-ttu-id="db5db-591">Dessa SKU:er har tagits bort från den slutliga prislistan från den 1 januari 2021 och kommer inte att vara tillgängliga för beställning just nu.</span><span class="sxs-lookup"><span data-stu-id="db5db-591">These SKUs have been removed from the January 1, 2021 final price list and will not be available to order at this time.</span></span> 

   |<span data-ttu-id="db5db-592">**Erbjudandets namn**</span><span class="sxs-lookup"><span data-stu-id="db5db-592">**Offer name**</span></span>|<span data-ttu-id="db5db-593">**Erbjudande-ID**</span><span class="sxs-lookup"><span data-stu-id="db5db-593">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="db5db-594">Dynamics 365 Finance for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="db5db-594">Dynamics 365 Finance for AX Migration Program</span></span>|<span data-ttu-id="db5db-595">7fbd1115-a4c1-4cf9-b881-40c4187ca581</span><span class="sxs-lookup"><span data-stu-id="db5db-595">7fbd1115-a4c1-4cf9-b881-40c4187ca581</span></span>|
   |<span data-ttu-id="db5db-596">Dynamics 365 Supply Chain Management for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="db5db-596">Dynamics 365 Supply Chain Management for AX Migration Program</span></span>|<span data-ttu-id="db5db-597">a3c62c0e-4f8a-4fc9-a47e-dec3310529d0</span><span class="sxs-lookup"><span data-stu-id="db5db-597">a3c62c0e-4f8a-4fc9-a47e-dec3310529d0</span></span>|
   |<span data-ttu-id="db5db-598">Dynamics 365 Commerce for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="db5db-598">Dynamics 365 Commerce for AX Migration Program</span></span>|<span data-ttu-id="db5db-599">97e98de6-24a8-4282-bad6-9d1a874e90a4</span><span class="sxs-lookup"><span data-stu-id="db5db-599">97e98de6-24a8-4282-bad6-9d1a874e90a4</span></span>|
   |<span data-ttu-id="db5db-600">Dynamics 365 Finance Attach till kvalificerande Dynamics 365-baserbjudande för AX-migreringsprogram</span><span class="sxs-lookup"><span data-stu-id="db5db-600">Dynamics 365 Finance Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span></span>|<span data-ttu-id="db5db-601">69d789e8-1e93-4dee-86b2-3ddfb03c08b9</span><span class="sxs-lookup"><span data-stu-id="db5db-601">69d789e8-1e93-4dee-86b2-3ddfb03c08b9</span></span>|
   |<span data-ttu-id="db5db-602">Dynamics 365 Supply Chain Management –anslutning till kvalificerande Dynamics 365-baserbjudande för AX-migreringsprogram</span><span class="sxs-lookup"><span data-stu-id="db5db-602">Dynamics 365 Supply Chain Management Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span></span>|<span data-ttu-id="db5db-603">c897adce-2964-4d24-abc3-7f7ad4b6a80d</span><span class="sxs-lookup"><span data-stu-id="db5db-603">c897adce-2964-4d24-abc3-7f7ad4b6a80d</span></span>|
   |<span data-ttu-id="db5db-604">Dynamics 365 Commerce Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="db5db-604">Dynamics 365 Commerce Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span></span>|<span data-ttu-id="db5db-605">ba1fe561-cfda-405a-a25d-ecda3bd3cba7</span><span class="sxs-lookup"><span data-stu-id="db5db-605">ba1fe561-cfda-405a-a25d-ecda3bd3cba7</span></span>|
   |<span data-ttu-id="db5db-606">Dynamics 365 Operations – Aktivitet för AX-migreringsprogram</span><span class="sxs-lookup"><span data-stu-id="db5db-606">Dynamics 365 Operations – Activity for AX Migration Program</span></span>|<span data-ttu-id="db5db-607">177e954e-1fff-4941-8967-55a47e36e1ce</span><span class="sxs-lookup"><span data-stu-id="db5db-607">177e954e-1fff-4941-8967-55a47e36e1ce</span></span>|
   |<span data-ttu-id="db5db-608">Dynamics 365 Operations – Device for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="db5db-608">Dynamics 365 Operations – Device for AX Migration Program</span></span>|<span data-ttu-id="db5db-609">8c8b7c8f-cb3a-4737-8319-1752938c7be3</span><span class="sxs-lookup"><span data-stu-id="db5db-609">8c8b7c8f-cb3a-4737-8319-1752938c7be3</span></span>|
   |<span data-ttu-id="db5db-610">Dynamics 365-teammedlemmar för AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="db5db-610">Dynamics 365 Team Members for AX Migration Program</span></span>|<span data-ttu-id="db5db-611">1eb3ad0b-9de3-419d-8bfe-0d61bdd945b2</span><span class="sxs-lookup"><span data-stu-id="db5db-611">1eb3ad0b-9de3-419d-8bfe-0d61bdd945b2</span></span>|

### <a name="next-steps"></a><span data-ttu-id="db5db-612">Nästa steg</span><span class="sxs-lookup"><span data-stu-id="db5db-612">Next steps</span></span>

<span data-ttu-id="db5db-613">Granska resurserna om det här avsnittet och dela dem med lämpliga intressenter i din organisation.</span><span class="sxs-lookup"><span data-stu-id="db5db-613">Review the resources about this topic and share them with the appropriate stakeholders in your organization.</span></span> 

### <a name="questions"></a><span data-ttu-id="db5db-614">Har du några frågor?</span><span class="sxs-lookup"><span data-stu-id="db5db-614">Questions?</span></span>

<span data-ttu-id="db5db-615">Om du har fler frågor om dessa erbjudanden kan du läsa dina Yammer communityer.</span><span class="sxs-lookup"><span data-stu-id="db5db-615">For any further questions about these offers, check your relevant Yammer communities.</span></span>
