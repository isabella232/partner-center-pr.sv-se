...
- Alla partner som samverkar via Cloud Solution Provider-programmet i EU/EFTA & Storbritannien

### <a name="details"></a>Information

I Europeiska unionen (EU)/European fri handels sammanslutningen (EFTA) och Storbritannien (UK) kommer alla nya handels erbjudanden i Cloud Solution Provider-programmet att använda partner fakturerings platsen i stället för kundens fakturerings plats. Det innebär att partner debiteras av Microsoft baserat på deras plats valuta, inte deras kunders plats valuta. Dessa ändringar görs i två faser:
...
Efter fas 2 kommer partners i EU/EFTA-& att faktureras i partner platsens valuta för alla kunder och alla CSP-inköp.
...
Den här uppdateringen minskar komplexiteten och kostnaderna för att fakturera med flera valutor i EU/EFTA & Storbritannien för den nya Commerce-upplevelsen.
...
28 januari 2021: republicing; inga ändringar.
...
Alla indirekta åter försäljare & indirekta leverantörer som agerar genom Cloud Solution Provider (CSP)-programmet.
...
För alla frågor som rör detta meddelande kontaktar du [Support för partner Center](https://partner.microsoft.com/support/v2/?stage=2&topicid=2da4e1c7-3b4b-5672-6227-56bc75a936b4)

________________
## <a name="partner-center-audit-log-changes-to-include-two-new-operation-types-for-dap"></a><a name="12"></a> Gransknings logg ändringar i Partner Center innehåller två nya åtgärds typer för DAP
...
________________
## <a name="changes-to-azure-offer-availability-in-csp-related-to-the-new-commerce-experience-in-csp-for-azure"></a><a name="11"></a> Ändringar i Azures erbjudande tillgänglighet i CSP som är relaterade till den nya Commerce-upplevelsen i CSP för Azure
...
________________
## <a name="perpetual-software-now-generally-available-for-the-cloud-solution-provider-program"></a><a name="10"></a> Beständig program vara är nu allmänt tillgänglig för Cloud Solution Provider-programmet
...
## <a name="security-compliance-and-identity-sci-launches-coming-on-february-1-2021"></a><a name="8"></a>Säkerhet, efterlevnad och identitet (området) lanseras den 1 februari 2021 
...
## <a name="docusign-migration-to-adobe-sign-for-partners-under-microsoft-partner-agreements-mpas"></a><a name="7"></a>DocuSign migrering till Adobe Sign för partner under Microsoft partner Agreement (MPAs) 
...
## <a name="commercial-pricing-update-for-norwegian-krone"></a><a name="6"></a>Kommersiell pris uppdatering för norska kronor 
...
Leverantörer av moln lösnings leverantörer med norska kronor.

### <a name="details"></a>Information

Från den 1 mars 2021 kommer norska kronor-priser för kommersiell lokal program vara och onlinetjänster ändras till att justeras mot gällande pris nivåer i regionen.
Det fullständiga meddelandet är bara tillgängligt för Microsoft-partner. [Logga in för att få åtkomst till hela meddelandet](https://partner.microsoft.com/resources/detail/pricing-update-norway-partners-pdf).

_____________ 

## <a name="commercial-pricing-update-for-the-indian-rupee"></a><a name="5"></a>Kommersiell pris uppdatering för den indiska rupien 
...
## <a name="license-base-price-list-updates-for-january-2021"></a><a name="3"></a>Licens – uppdatering av pris lista för januari 2021 
