...
________________
## <a name="sandbox-support-for-indirect-model-to-enable-end-to-end-api-testing"></a><a name="15"></a>Sandbox-stöd för indirekt modell för att aktivera API-testning från slutet till slut
...
- Den indirekta sandbox-återförsäljaren kräver inte att en verklig indirekt återförsäljare registrerar sig.
...
Detta är ett känt problem. Vi arbetar med att åtgärda detta och kommer att tillhandahålla uppdateringar när vi har dem.
...
När du skapar den första indirekta sandbox-återförsäljaren anspelar du på inloggningsuppgifterna och följer sedan proceduren nedan.

1. Logga in på [instrumentpanelen i Partnercenter med dina](https://partner.microsoft.com/dashboard/) autentiseringsuppgifter för sandbox-miljön för indirekta återförsäljare.

2. Välj **Inställningar** och sedan **Kontoinställningar.**

3. Välj fliken **Användarhantering** och välj sedan användarens e-postadress.

4. I den nedrullningsbara menyn väljer du Assist your customer as (Hjälp **kunden som)** och **Admin Agent (Administratörsagent).**
...
Det här är ett känt problem som kommer att åtgärdas snart.

### <a name="next-steps"></a>Nästa steg

Indirekta sandbox-leverantörer kan börja skapa indirekta sandbox-återförsäljare. Du kan också skapa och bjuda in kunder och genomföra transaktioner med den indirekta sandbox-återförsäljarens PARTNER of Record (POE). När du är klar med testningen bör du ta bort alla prenumerationer och kunder innan du tar bort återförsäljaren.

### <a name="questions"></a>Har du några frågor?

Frågor om dessa erbjudanden finns i Partnercenter-SDK [API.](https://www.yammer.com/cloudpartnercommunity/#/threads/inGroup?type=in_group&feedId=6589502)

________________
## <a name="june-online-services-ols-and-software-channel-authorization-guide"></a><a name="14"></a>Auktoriseringsguide för June Online Services (OLS) och Software Channel
...
Partner för direktfakturering, indirekta leverantörer och partner på flera Molnlösningsleverantör (CSP)-programmet

### <a name="details"></a>Information

I enlighet med Microsoft-partneravtal (i avsnittet OLS-programvara och kanalauktorisering/meddelande om ändringar/ändringar i guiderna) meddelar Microsoft dig att auktoriseringsguiden för OLS och programvarukanal håller på att uppdateras. En förhandsgranskning av den uppdaterade guiden [finns här,](https://partner.microsoft.com/resources/detail/update-guide-online-services-software-channel-authorization-june-pdf)med en röd linje som visar ändringar [som är tillgängliga här.](https://partner.microsoft.com/resources/detail/update-guide-online-services-software-channel-authorization-june-redline-pdf) Den här uppdateringen börjar gälla 30 dagar från datumet för det här meddelandet. Du behöver inte göra något mer.
...
________________
## <a name="updates-on-transacting-perpetual-software-in-csp-and-changes-to-the-open-license-program"></a><a name="13"></a>Uppdateringar om hur man överför permanent programvara i CSP och ändringar i Open License-programmet
...
Ytterligare resurser och uppdateringar är tillgängliga för partner som förberedelse för att göra permanenta program i Molnlösningsleverantör-programmet (CSP), samt ändringar i Open License-programmet.
...
Efter [aprilmeddelandet](./2021-april.md#7)om viktiga datum och återförsäljarmaterial kan du se ytterligare resurser och uppdateringar som hjälper dig och dina återförsäljare att förbereda för att göra transaktioner med permanent programvara i CSP och ändringarna i Open License-programmet.
...
Från och med 1 januari 2022 kan du som du vet inte beställa några förnyelser av Software Assurance eller nya inköp av programvarulicenser i Open License-programmet. Det innebär att många partner och deras kunder behöver övergå till att sälja programvarulicenser via CSP-programmet.
...
- **Partner Center onboarding och översikt för indirekta återförsäljare i CSP:** Det finns ett webbseminär den 2 och 3 juni. [Registrera dig här.](https://globalpbocomm.eventbuilder.com/OpenMigrationToCSPOV)

- **Övergångsmaterial för Reseller Open License to CSP:** Anpassningsbara material som hjälper indirekta leverantörer att påskynda återförsäljares registrering och införande av permanent programvara i CSP-programmet finns [här.](https://partner.microsoft.com/resources/collection/reseller-open-license-to-csp-transition-materials#/)

- **Registrering av Open Value-åtgärder:** Det finns ett webbsyssar för att stödja ett scenario för kundövergång från Open License till Open Value den 9 och 10 juni. Se [licensieringsvägledningen](https://partner.microsoft.com/resources/detail/csp-open-evolution-to-a-better-experience-licensing-guidence-pdf) för alla övergångsscenarier. [Registrera dig här.](https://globalpbocomm.eventbuilder.com/OpenMigrationToCSPOV)
...
#### <a name="reminder-changes-to-the-csp-return-period-and-software-download-link-expiry-dates"></a>Påminnelse: Ändringar i CSP-returperioden och förfallodatum för nedladdningslänken för programvara

Anteckna följande ändringar för kontinuerliga programvaru- och programvaruprenumerationsköp via Partnercenter:

- **1 juni 2021:** Returperioden för programvaruerbjudanden i CSP, som anges i Microsoft-partneravtal, ändras från 60 dagar från orderdatumet till 30 dagar från orderdatumet.

- **3 juni 2021:** Nedladdningslänkar för programvara för permanent programvara och produktköp av programvaruprenumeration via Partnercenter har ett förfallodatum på fem dagar från den första nedladdningen.

Mer information [och vanliga frågor](./2021-april.md#8) och svar finns i det fullständiga meddelandet.

### <a name="next-steps"></a>Nästa steg

Befordra webbseminorna med dina återförsäljare (registrera dig[här)](https://globalpbocomm.eventbuilder.com/OpenMigrationToCSPOV)och använd följande resurser för att påskynda återförsäljares övergång till CSP:
...
- [CSP-returperiod och nedladdningslänk för programvara upphör att gälla](https://partner.microsoft.com/resources/collection/csp-software-return-period-download-expiry-faq#/)
...
________________
## <a name="phase-2-coming-soon-euefta-and-uk-change-of-partner-billing-currency-for-new-commerce-offers"></a><a name="12"></a>Fas 2 kommer snart: EU/EFTA och Storbritannien byter partnerfaktureringsvaluta för nya handelserbjudanden
...
Partner som gör en Molnlösningsleverantör(CSP) i regionen EU/EFTA och Storbritannien
...
- Partner som använder Microsoft-API:er eller en tredje parts leverantör av kontrollpanelen (CPV) för alla typer av faktureringsautomatisering måste göra nödvändiga ändringar för att anpassa valutaändringen för kunden.
...
________________
## <a name="deprecation-of-microsoft-365-business-voice-getting-started-wizard-gsw"></a><a name="11"></a>Utfasning av Microsoft 365 Business Voice Komma igång Wizard (GSW)
...
Guiden Microsoft 365 Business Voice Komma igång (GSW) dras tillbaka den 1 juni 2021 och ersätts med en förbättrad Teams Admin Center-upplevelse och ny installationsdokumentation.
...
Microsoft 365 Business Voice har bidragit till att transformera hur små och medelstora företag kommunicerar, samtidigt som effektivitet, förenklar teknikhanteringen och sparar kostnader.
...
Från och med den 1 juni 2021 dras Microsoft 365 Business Voice Komma igång Wizard (GSW) tillbaka och ersätts med en förbättrad Teams Admin Center-upplevelse och ny, djupgående dokumentation för att underlätta inledande Business Voice-konfiguration. Detta omfattar stegvisa instruktioner för anskaffning av telefonnummer, tilldelning av licenser och telefonnummer, samtalsköer och automatisk dirigering.
...
Om du är en partner i USA, Storbritannien eller Kanada och säljer Business Voice med samtalsplan rekommenderar vi att du bekantar dig med den nya [stegvisa](/microsoftteams/business-voice/set-up-overview) dokumentationen (som finns i dokumentationshubben [för Microsoft 365 Business Voice)](/microsoftteams/business-voice/)så att du är beredd att stödja kunder som kan behöva hjälp med att konfigurera Business Voice.

### <a name="resources"></a>Resurser

- [Dokumentation om att konfigurera Business Voice](/microsoftteams/business-voice/set-up-overview)
- [Microsoft 365 dokumentationshubb för Business Voice](/microsoftteams/business-voice/)
...
________________
## <a name="may-cloud-solution-provider-csp-community-update-and-reminders"></a><a name="10"></a>Kan Molnlösningsleverantör (CSP)-communityuppdatering och påminnelser
...
Microsoft bygger vidare på detta och utökar möjligheterna för CSP-partner med lanseringen av kommersiella permanenta programvarulicenser utan Software Assurance (SA) för lokal distribution via *MCCL CSP, som riktar sig mot Q1 av Microsoft FY22. Detta ger kunderna den licensieringsflexibilitet som de behöver som en del av den digitala omvandlingen.
...
Prislistan för licensbaserade tjänster som publicerades den 1 maj 2021 innehåller ett felaktigt pris för USD för Microsoft 365 Business Standard. Det publicerade listpriset var 8 USD, när det borde ha varit 10 USD. Prislistan för licensbaserade tjänster uppdaterades den 3 mars 2021 kl. 11:30 PST med korrigeringarna. De här korrigeringarna gäller endast för:
...
Ett API-exempel finns [i Hämta en kunds kvalificering asynkront](/partner-center/develop/get-customer-qualification-asynchronous.md).
