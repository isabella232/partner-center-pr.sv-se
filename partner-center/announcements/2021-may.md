...
________________
## <a name="sandbox-support-for-indirect-model-to-enable-end-to-end-api-testing"></a><a name="15"></a>Sandbox-stöd för indirekt modell för att aktivera API-testning från end-to-end
...
Läs mer i vår guide för att [få referensinsikter i Partnercenter.](../referral-insights.md)
