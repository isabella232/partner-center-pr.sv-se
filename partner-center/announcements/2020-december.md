...
Direktfaktureringsleverantörer och indirekta leverantörer som deltar i Molnlösningsleverantör(CSP)-programmet.
...
## <a name="reminder-perpetual-software-in-the-cloud-solution-provider-csp-program-broadly-available-from-january-2021"></a><a name="7"></a>Påminnelse: Beständig programvara i Molnlösningsleverantör-programmet (CSP) är allmänt tillgängligt från januari 2021
...
- Funktionen för programvaru- och licensuppfyllelse i [](./2020-september.md#17) Partnercenter kommer att dras tillbaka – se meddelande – och partner kommer att peka kunder att använda administrationscentret för Microsoft 365 exklusivt för detta ändamål i framtiden. Detta säkerställer den säkraste och effektivaste upplevelsen för kunderna. Läs mer om programmet Microsoft 365 Administrationscenter i [översikten,](https://support.microsoft.com/office/admin-center-overview-fa715fa8-6eda-456d-b177-d1c156edd1b3) [vanliga](/microsoft-365/admin/admin-overview/about-the-admin-center?preserve-view=true&view=o365-worldwide)uppgifter och licensfunktioner för [nyckeluppfyllelse.](https://partner.microsoft.com/resources/detail/microsoft-365-admin-center-software-key-download-pdf)
...
Nedanstående erbjudanden fanns med i matrisen med erbjudandelistor. De är inte tillgängliga, det finns inget måldatum än för tillgänglighet. Partner bör ignorera dessa radobjekt.

   |**Erbjudandets namn**|**Erbjudande-ID**|
   |-------------------|:------|
   |Dynamics 365-åtgärder – databaskapacitet (priser för ideella organisationer)|1d3f4d81-89b9-419e-a880-31b2c50b8d66|
   |Dynamics 365-åtgärder – filkapacitet (priser för ideella organisationer)|dc173a86-285b-444c-881e-3ece531f67da|
...
## <a name="an-update-of-the-us-microsoft-365-business-voice-with-calling-plan-offer-is-coming-soon"></a><a name="2"></a>En uppdatering av erbjudandet Microsoft 365 Business Voice med samtalsplan kommer snart
...
## <a name="now-live-partner-center-api-updates-and-user-interface-enhancements-for-the-education-customer-validation-process"></a><a name="1"></a>Nu live: Partner Center API-uppdateringar och förbättringar av användargränssnittet för kundvalideringsprocessen för Education
...
Partner som säljer Academic-erbjudanden via Molnlösningsleverantör program

### <a name="summary"></a>Sammanfattning 

Microsoft körs med förtroende. Vi strävar efter att tillhandahålla en kompatibel, säker och säker metod för kundvalidering för att transacting Academic-erbjudanden i Molnlösningsleverantör-programmet. Som en del av det här åtagandet introducerar vi Partner Center API och förbättringar av användargränssnittet som ökar tydligheten och insynen i kundens granskningsprocess samt möjligheten att mata in mer korrekta data, vilket ger bättre resultat för kunderna. 
