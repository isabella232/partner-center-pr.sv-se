...
Vi kommer också **Microsoft 365-applikationer** som nytt namn för våra två Office klientprenumerationer:
...
Det sker inga ändringar i priser, funktioner eller affärsmodell. Det finns inte heller några namngivningsändringar i SKU Office 365 Enterprise- och Microsoft 365 Enterprise-SKU:er. Alla SKU:er och namnbyten för erbjudanden flödar automatiskt till prenumerationsnamn i Partnercenter.
...
- [Hjälpartikel om Molnlösningsleverantör (CSP) direktfaktureringspartner till indirekt CSP-återförsäljare](../transition-direct-to-indirect.md#move-your-direct-bill-customers-to-your-indirect-provider)
...
Den 1 april 2020 introducerar Microsoft en ny SKU på ny nivå och flyttar Microsoft 365 Enterprise SKU-uppställningen.
...
De här ändringarna ger bättre värde för första raden Arbetare och gör det möjligt för partner att utnyttja en betydande möjlighet till användartillväxt.

|**Ändra tidslinje**|**Ändra**|
|-------------------|:------|
|Den 1 mars 2020|Den nya SKU:n på startnivå publiceras i listan med förhandsversionspriser, med det tillfälliga namnet Microsoft 365 F0|
...
**Ytterligare värde fylls i i dina planer för M365 F1, O/M365 F3 den 1 april 2020.**
...
Bekanta dig med prislistan för förhandsversionen. Tänk på att den 1 april 2020 kommer Microsoft 365 F0 att Microsoft 365 F1. Omvänt kommer Microsoft 365 F1 att få en ny Microsoft 365 F3.
...
I april 2020 utökar Microsoft bredden och värdet av Microsoft 365 abonnemang.
...
- Mer information om Microsoft Defender Avancerat skydd finns här: [https://www.microsoft.com/microsoft-365/windows/microsoft-defender-atp?ocid=cx-blog-mmpc](https://www.microsoft.com/microsoft-365/windows/microsoft-defender-atp?ocid=cx-blog-mmpc)
