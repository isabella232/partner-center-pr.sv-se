...
|Microsofts säljarinformation|Visas så fort ett avtal skapas.|Microsofts säljarinformation är inte synlig för partner eftersom avtalstypen är partnerledd.
|Lösningar|Ett val annat antal lösningar kan läggas till i avtalet.|Partner kan lägga till högst 50 lösningar i avtalet.
|Avtalstilldelning|Endast tilldelad säljare kan visa och agera på avtal.|Hänvisningsanvändare som lagts till i teamavsnittet i ett avtal kan visa och agera på avtalet. Referensadministratörer för DEN MPN-plats där avtalet har skapats kan visa och agera på avtalet.|
