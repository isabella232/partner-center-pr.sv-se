...
**Lämpliga roller:** Kontoadministratörsroller | Referenser admin | PsC-Anslut (Partner Sales | Partner Sales Anslut administratör (PSC) | Avtalsansvarig Anslut Partner Sales Anslut (PSC)
...
> [!IMPORTANT]
> Från och med 15 augusti 2021 kommer ditt företag inte att kunna skapa eller redigera avtal i PSC. **Du kommer fortfarande att kunna ladda ned befintliga avtalsdata med hjälp av massexport-funktionen i PSC. Du kan också [migrera öppna avtal](partner-sales-connect-to-partner-center-iot.md#psc-deals-migration) från PSC till Partnercenter efter detta datum.**

Som du vet **förlorar ditt företag åtkomst till PSC efter den 30 augusti 2021.** Du hittar dock fortfarande allt du vill göra i Partnercenter, till exempel skapa och hantera avtal.
...
## <a name="before-you-move-things-you-need-to-know"></a>Innan du flyttar måste du känna till saker du behöver veta
...
1. Välj kugghjulsikonen Inställningar i instrumentpanelen i Partnercenter och sedan **Kontoinställningar.**

2. Välj **Användarhantering** på den vänstra navigeringsmenyn på den andra nivån.
...
> - Om din roll även omfattar hantering av iot-avtal kan du be att [tilldelas](permissions-overview.md#manage-referrals) användarrollen referensadministratör eller referenser efter behov.
...
2. PSC-användaren kanske använder ett konto från en annan domän än den du använder i Partnercenter.
   ...
   1. Logga in på [instrumentpanelen i Partnercenter](https://partner.microsoft.com/dashboard) och välj Inställningar kugghjulsikon och sedan **Kontoinställningar.**
...
> [!NOTE]
> Från det att migreringen har startats kan det ta upp till 24 timmar innan alla avtal har migrerats.
...
> [!IMPORTANT]
> Härnäst bör du skaffa dig hur du skapar och hanterar IoT-avtal i Partnercenter. Det här är ett viktigt steg som förbereder dig för IoT-avtalshantering. Förstå arbetsflödena och ändringarna i Partnercenter så att du effektivt kan skapa och hantera avtal. Börja med att läsa det här dokumentet helt.
...
|Kundorganisation|Fritextpost.|Du kan söka i [kundorganisationen](manage-co-sell-opportunities.md#select-your-customer) mot [databasen D&B](https://www.dnb.com/) genom att bara skriva några tecken. Det juridiska namnet och adressen fylls i automatiskt baserat på valet.|
...
### <a name="the-new-deal-button-is-greyed-out-for-our-account-what-should-i-do-to-start-creating-deals"></a>Knappen för nytt avtal är nedtonad för vårt konto. Vad ska jag göra för att börja skapa avtal?
...
Affärsmöjlighets-ID:t i PSC är samma som hänvisnings-ID:t i Partnercenter. Du hittar referens-ID:t bredvid avtalsnamnet när du öppnar ett avtal.

## <a name="next-steps"></a>Nästa steg

- [Låt företaget växa med hänvisningar](./grow-your-business.md)