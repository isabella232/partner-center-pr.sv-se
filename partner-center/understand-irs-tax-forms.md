...
|1042-S | Relaterade till betalningar som görs till dig och som USA källskatten | Utskrivna formulär publiceras den **15** mars eller före den 15 mars, och PDF-kopior kommer att vara tillgängliga i Partnercenter (i **partnercenters** utvecklarinställningar under Utbetalnings- och skatteprofiler **>** Utbetalnings- och skatteprofiler ) samtidigt  |

> [!NOTE]
> Den adress som vi använder på skatteformulär för IRS kommer från adressen i skatteprofilen när du ställer in [ditt utbetalningskonto och skatteformulär.](set-up-your-payout-account.md) Om din adress har ändrats ser du till att uppdatera adressen i din **skatteprofil**.
...
| Affärsgrupp         | Juridisk person          | Adress                                          |
|------------------------|-----------------------|--------------------------------------------------|
| Windows, Office, Azure | Microsoft Ireland Operations Limited (betalningen görs av Microsoft Corporation via Microsoft Ireland som en kvalificerad mellanhand för Microsoft Corporation) | One Microsoft Place<br>South County Business Park<br>Öje, Dublin 18, D18 P521, Irland|
| Annonsering          | Microsoft Ireland Operations Limited (betalning görs av Microsoft Online Inc. via Microsoft Ireland och fungerar som utbetalningsagent för Microsoft Online Inc.) | One Microsoft Place<br>South County& Business Park<br>Öje, Dublin 18, D18 P521, Irland |
| Annonsering            | Microsoft Online Inc. | 6880 Sierra Center Parkway<br>Reno, NV 98511 USA |

>[!NOTE]
> \* Medborgare i följande länder som tjänar reklamintäkter kommer att betalas via Microsoft Ireland Operations Limited: Schweiz,Arbet,Arbet, Härlighet, Hälsa, Tjeckiska, Fall, Fall, Frankrike, Tyskland, Underlig, Irland, Isle of Man, Italien, Let, Eta, 10, 10, 15, 10, 10, 2010, 100 000, 100 000, 100 000 000 och 2015.
...
| Jag har **fått minst 10** USD i betalningar för (i) appförsäljning som gjorts i Brasilien och Kina via Microsoft Store på Windows 10 eller (ii) försäljning på Marketplace För appar.<br/><br/>**OR**<br/><br/>Jag fick minst 600 USD i betalningar som inte rör appförsäljning från Microsoft under det tillämpliga skatteåret (till exempel incitamentbetalningar eller betalningar från en deltagare eller befordran)| **1099-MISC:**<br/>Betalare: Microsoft Corporation<br/>HAR: \* \* \* \* \* 4442<br/><br/>**Viktigt:** Vissa affärsenheter får inte 1099-MISC-formulär oavsett vilka betalningsbelopp som tas emot från Microsoft.  Kontakta din skatteproffs om du vill ha mer information.| 
...
| **Fråga** | **Svar** |
|---|---|
| **Jag har fått ett formulär 1042-S från Microsoft. Vad används den till?** | Microsoft har försedt dig med ett formulär eller formulär på 1 042 S eftersom vi har betalat dig intäkter som anses vara rapportbara för USA-skatteverket och som var föremål för källskatt.  Formulär 1042-S används för det här rapporteringskravet. | 
| **Vad ska jag göra med formulären?** | I allmänhet krävs ingen specifik åtgärd från din sida. Formuläret 1042-S kan vara användbart för dig om du vill ansöka hos dina lokala skattemyndigheter om någon form av skattekredit.  Kontakta dina egna skatterådgivare för att få mer information om det här ämnet. | 
| **Varför gjordes skatt på mina betalningar när jag slutförde ett W8-formulär?** | Skatter kommer att tas med om något av följande:<br/><br/>1. Du har inte slutfört skatteavsnittet i W8 korrekt, eller <br/>2. Du är hemmahörande i ett land som inte har skatteavtal med USA.<br/><br/>Du kan när som helst besöka Partnercenter för att skicka ett uppdaterat W8-formulär.<br/><br/> **Obs!** Det är inte alla intäkter som omfattas av källskatt. | 
