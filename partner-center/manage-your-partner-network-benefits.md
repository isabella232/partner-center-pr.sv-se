...
4. **Teknisk support (Break-fix).** Använd den här typen av teknisk support när funktionen bryts eller när något inte fungerar som förväntat (till exempel när du får ett felmeddelande). Här är några riktlinjer:
