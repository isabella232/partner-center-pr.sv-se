...
2. Leta upp den produkt som du vill börja använda och välj sedan nedåtpilen längst till höger på raden för att expandera produktens information.
...
2. Välj **Fördelar** och sedan **Tekniska fördelar från** den vänstra navigeringsmenyn. Sidan Tekniska förmåner visas med en lista över tekniska supportförmåner som är tillgängliga för alla dina guld-, silver- eller Microsoft-Action Pack kompetenser.

   Om du inte ser de här alternativen eller sidan Tekniska [](permissions-overview.md) förmåner kanske du inte har rätt användarroller tilldelade i Partnercenter. Kontakta din globala partnercenteradministratör för att få åtkomst.

3. Expandera listan över fördelar. För att komma igång med en specifik supportförmån måste du göra följande första gången du använder den:

   - **Aktivera den tekniska förmånen.** När du har expanderat information om en förmån väljer du **Aktivera**. Det kan ta några dagar att bearbeta din aktiveringsbegäran.

   - **Visa och dela produktsupport åtkomst-ID och kontrakt-ID.** När din aktiveringsbegäran har bearbetats visas information om **åtkomst-ID** och **kontrakt-ID** nästa gång du expanderar den tekniska förmånen. Du eller ditt företags användare måste dela och använda den här informationen första gången du skickar en supportbegäran för vissa typer av produkter eller tjänster.

4. När den har aktiverats kan du använda tekniska fördelar för olika typer av teknisk support. Om du vill skicka in tekniska supportförfrågningar för följande tjänster kan du läsa de detaljerade anvisningarna på sidan Tekniska förmåner. Se även informationen nedan.

   Sidan Tekniska förmåner för Partnercenter beskriver följande typer av teknisk support:

   **Teknisk support (Break-fix).** Använd den här typen av teknisk support när funktionen är bruten eller när något inte fungerar som förväntat (till exempel när du får ett felmeddelande). Här är några riktlinjer:

   - För Gold/Silver-kompetenspartner (inte tillgängligt för Action Pack prenumeranter) använder du Signature Product Support for Cloud products **(Signaturproduktsupport** **för molnprodukter).**
