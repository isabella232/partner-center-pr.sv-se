...
Kund land|Ja|Land/region där kund organisationen finns. Använd de två lands koderna för bokstäver som anges [här]( https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes).|USA
...
Partner hänvisnings status|Ja|Anger status för affären från ditt företags perspektiv. Krävs om du försöker skapa eller ändra en referens. Använd **ny** om du försöker skapa ett nytt avtal. Godkända värden dokumenteras [här](/partner/develop/referral-resources#referralstatus).|Aktiv
Under status för partner referral|Ja|Anger den exakta statusen för affären. Använd **accepterat** om du försöker skapa ett nytt avtal. Det krävs också om du ändrar en befintlig hänvisning. Godkända värden dokumenteras [här](/partner/develop/referral-resources#referralsubstatus).|Har godkänts
