...
3. **Funktionskonsulter:** Antalet personer som har en aktiv Funktionskonsult Associate-certifiering för Dynamics 365. (Mer information om det här måttet finns [i Definitioner för funktionskonsulter](partner-contribution-indicators.md#definitions-for-pci-metric-3---functional-consultants).)
...
- Partner är associerade med klienter på prenumerationsnivå. Prenumerationer mappas till följande kvalificerande Customer Engagement-produkter eller till Finance and Operations-produkter:
  ...
  - Produkter som kvalificerar sig för Finance and Operations omfattar: Unified Operations, Finance, Supply Chain Management, Retail, Commerce, Plan 2, Mixed Reality, Talent och Enterprise Team Member.
