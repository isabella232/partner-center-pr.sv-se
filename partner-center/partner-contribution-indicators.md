...
I den här artikeln beskrivs sju nyckelindikatorer för partnerbidrag (PCI) som används för att utvärdera en partners framsteg mot att uppnå eller behålla en silver- eller Business Applications kompetens.
...
Bidragsindikatorer för partner ger ett holistiskt mått på en partners inverkan på lyckade kundresultat och därmed större differentiering på marknaden när en partner uppnår eller behåller silver- eller guldmolnet Business Applications kompetens.

Med PCI får partner kredit för viktiga mått på kundframgång, till exempel lyckade distributioner och ökad användning. De får pris för att de fortsätter att investera i och skala ut sina tekniska funktioner.

När en partner uppnår vissa nivåer av påverkan i kpi:er kan partnern till exempel uppnå (eller behålla) silver- eller guldmolnskompetensen Business Applications kompetens.
...
- [Tabell 2. Finance and Operations-tröskelvärden](partner-contribution-indicators.md#table-2-finance-and-operations-thresholds-for-this-competency)
...
- Endast för Enterprise-avtalsintäkter: Den här intäkten omfattar intäkter från avtalets första år. Återkommande intäkter från det andra och tredje året ingår inte.
