...
1. Kontrollera att dina partnerprofiler i Partnercenter och MPN Microsoft Partner Network-ID:t är aktuella.

2. Logga in på [instrumentpanelen i Partnercenter](https://partner.microsoft.com/dashboard) som global administratör för den direktfaktureringsklient som du övergår till en indirekt återförsäljare.

3. Granska din partnerinformation i registreringsformuläret.

   :::image type="content" source="images/direct/direct2a.png" alt-text="Skärmbild som visar registreringsknappen.":::
...
> [!IMPORTANT]
> När du registrerar dig som en indirekt återförsäljare med den nya funktionen finns det inget alternativ för att återställa till en klientorganisation som endast faktureras direkt. Se till att du utvärderar dina affärsbehov fullständigt innan du registrerar dig som indirekt återförsäljare.
...
>[!NOTE]
>Sandbox-funktionerna är bara tillgängliga för direktfaktureringspartner. När du övergår från direktfakturering till indirekt återförsäljare förlorar du åtkomsten till sandbox-funktionerna.
...
6. Kontrollera att prenumerationerna inte längre visas som aktiva på **sidan** Prenumerationer:
   ...
   - Om det här är en Azure-prenumeration (MS-AZR-0145P) visas den inte längre.

   - Om det här är en licensbaserad prenumeration (Office 365, Dynamics, Intune) visas den med tillståndet **Pausad**.
