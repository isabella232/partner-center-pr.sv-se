...
| ------ | ----------- | ------------ |
| PartnerId | Unik identifierare i GUID-format för en specifik faktureringsenhet. Krävs inte för avstämning. Samma i alla rader. | *0e195b37-4574-4539-bc42-0e539b9684c0* |
