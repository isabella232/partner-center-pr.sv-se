...
Vyn Kostnadsanalys visar kostnaderna för ditt faktureringskonto för alla tjänster som köpts och förbrukats till de priser som du betalar för Microsoft.
...
PEC-intäkter räknas in i raden med justerade nettoavgifter på fakturan. Se filen för månatlig fakturaavstämning och Azures dagliga klassificerade användning för justeringsinformation.
