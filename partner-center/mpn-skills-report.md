...
[Kontrollera](ms-learn-associate.md) om de MCP:er som är associerade med dina användares Learning- eller Partner University-konton redan har associerats med deras användarkonton i Partnercenter.
...
- Bevisa att användaren har slutfört relevanta Microsoft-prov, certifieringar eller utbildning och utvärderingar. Se följande exempel på bevis.
   ...
   > [!NOTE]
   > Partner Center identifierar för närvarande endast certifiering från två källor, Microsoft Learning och Partner University. Alla andra certifikat som tas emot från andra källor (till exempel OpenedX) beaktas inte.
