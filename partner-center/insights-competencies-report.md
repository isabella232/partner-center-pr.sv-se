...
- Kunskaper: Kraven omfattar ofta prov, utvärderingar eller certifieringar som personer i företaget måste klara.

- Prestanda: För att vara berättigat till en kompetens måste företaget uppfylla vissa prestandatrösklar som är anpassade till kompetensområdet. Ditt företag kan till exempel behöva uppfylla en minsta mängd Azure-förbrukning under de avslutande 12 månaderna.

## <a name="competencies-report-details"></a>Information om kompetensrapport
...
I sammanfattningsvyn visas antalet kompetenser med deras namn på varje kompetensnivå (guld/silver) i alla faser i kompetenslivscykeln. Faser i kompetenslivscykeln omfattar: **Startad**, **kvalificerad,** **aktiv** och **i riskzonen.** Exempel: Kraven på molnkompetens finns i två kategorier: färdigheter och prestanda.

- Startad: Antal kompetenser som du har ett eller flera av de underliggande kraven för.
...
2. Anniversary Year-vy: Här räknas partnerns resultat upp från föregående årsdag till nästa årsdag.
