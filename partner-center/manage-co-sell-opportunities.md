...
|**Kommentarer**| Valfritt | Uppdatera all den senaste informationen för att ge insyn till andra anställda från ditt företag som arbetar med samma avtal eller försöka förstå det aktuella tillståndet för avtalet. Du kan också använda detta som en kommunikation om registrering för diskussioner mellan Microsoft-säljare/andra partner med ditt företag.|
...
- **Mitt företags lösningar:** Det här är lösningar för säljförsäljning som publiceras av ditt företag
...
|Kvalificerad|20%|Kvalificera avtalets värde och kundkraven innan du fortsätter.|
...
- Avtalstypen är antingen samförsäljning eller partnerledd.
...
Du kan välja att registrera avtalet direkt efter att ha markera avtalet som won (vunnit) eller vid ett senare tillfälle genom avtalslivscykeln **registrera nu-knappen.**
...
Arbetsflödet nedan förklarar hur e-postmeddelanden skickas till partner från referenssystemet i Partnercenter för nya inkommande partnerreferenser.
