...
2. På **välkomstsidan ser** du till att du har den information du behöver för att registrera dig och väljer sedan **Nästa.**
...
4. Associera ditt MPN-ID med ditt CSP-konto. Ditt CSP-konto och tillhörande MPN-ID måste finnas i samma land och ditt MPN-ID måste finnas i Partnercenter.
    ...
    2. Välj **Inställningar**, **Inställningar,** **Organisationsprofil** och sedan **Identifierare**.
...
6. När Microsoft har slutfört din registreringsverifiering som tar 3–5 arbetsdagar [](https://partner.microsoft.com/pcv/dashboard/overview) signerar du Microsoft-partneravtal på Partnercenter-instrumentpanelens översikt med globala administratörsautentiseringsuppgifter. Om du vill visa och **ladda Microsoft-partneravtal** innan du signerar den klickar du Microsoft-partneravtal länken enligt nedan.  Om ditt konto har fastnat i verifieringen efter 5 arbetsdagar läser [du Kontoverifieringsprocessen.](verification-responses.md)
...
8. När ditt Partnercenter-konto är redo att användas kontrollerar du att du har lagts till i administratörsagentgruppen. För att slutföra inställningen av ditt konto, inklusive att lägga till andra användare, måste du ha administratörsagentbehörigheter. Följ dessa steg om du vill visa eller uppdatera dina behörigheter:
