...
Mer information om vad som krävs för att sälja i CSP-programmet som en indirekt återförsäljare finns i Kom [igång](https://partner.microsoft.com/cloud-solution-provider/whats-required) som indirekt återförsäljare [på Microsoft Partner Network webbplats.](https://partner.microsoft.com/)
...
- **Företagets juridiska namn, adress, primär kontakt och supportinformation**
   ...
   Vi behöver den här informationen för att bekräfta att ditt företag har en etablerad profil hos Microsoft och att du har behörighet att agera för dess räkning.

   Det kan ta flera dagar att granska och verifiera den information som du har angett. Vi skickar din primära kontakt via e-post när vi har slutfört vår granskning.
...
4. Ange eller uppdatera företagets juridiska profil, primära kontaktinformation och kundsupportinformation. (Om du vill hitta din juridiska företagsinformation väljer **du Organisationsprofil** och sedan **Juridisk information**.) Välj **Registrera nu.**
...
5. Associera ditt MPN-ID med ditt CSP-konto. Ditt CSP-konto och tillhörande MPN-ID måste finnas i samma land och ditt MPN-ID måste finnas i Partnercenter.
   ...
   a. Logga in på Partner Center med dina MPN-kontoautentiseringsuppgifter (dina MPN-autentiseringsuppgifter kan vara annorlunda än dina CSP-autentiseringsuppgifter).
   
   b. Gå till **Inställningar**  ->  **Kontoinställningar**  ->  **Organisationsprofilidentifierare**  ->  .
 
    c. Hitta MPN-ID:t med typen "Plats" som matchar landet för det här CSP-kontot. 

    d. Om du inte hittar platsens MPN-ID som matchar det CSP-konto som du vill använda kan du lägga till en ny plats som skapar ett nytt MPN-ID. Läs mer [i Hantera platser.](manage-locations.md)

    e. Du kan skjuta upp det här steget tills nu, men du kommer inte att kunna signera Microsoft-partneravtal (MPA) eller göra en åtgärd i CSP förrän du har associerat ditt MPN-ID med ditt CSP-konto.

 > [!IMPORTANT]  
 > Välj det MPN-ID som är tillgängligt i Partnercenter och i samma land som ditt CSP-konto och kontrollera att ditt MPN-ID finns i Partnercenter.
...
7. Bekräfta att du har signerat Microsoft-partneravtal i avsnittet **Programinformation** i Partnerprofil. Dessutom visas ett meddelande om bekräftelsebanderoll på CSP-översiktssidan. 
...
8. När ditt Partnercenter-konto är redo att användas kontrollerar du att du har lagts till i administratörsagentgruppen. För att slutföra inställningen av ditt konto, inklusive att lägga till andra användare, måste du ha administratörsagentbehörigheter. Följ de här stegen för att visa eller uppdatera dina behörigheter:
   ...
   1. Från instrumentpanelen i Partnercenter väljer du **ikonen** Inställningar och **sedan** Användarhantering under **Kontoinställningar.**
...
När du arbetar med en indirekt leverantör kan du erbjuda ett bredare urval av Microsofts molnbaserade tjänster och lösningar till dina kunder. Indirekta leverantörer har system och infrastruktur för att erbjuda en robust fakturerings- och supportnivå. Genom att förlita dig på dem på det här sättet kan du fokusera på dina tekniklösningar och kundengagemang.

Om du inte redan arbetar med en leverantör (även kallat distributör) kan du söka i listan över officiella [Microsoft-leverantörer för](https://partnercenter.microsoft.com/partner/find-a-provider) att hitta en. När du hittar en leverantör som du vill samarbeta med kan du kontakta dem direkt för att diskutera deras återförsäljarprogram, supportnivå och villkor. Om både du och providern vill arbeta tillsammans måste du ansluta dina konton i Partnercenter.

Om en indirekt leverantör vill ansluta till dig i Partnercenter startar de följande arbetsflöde:
...
3. Om du vill bekräfta samarbetet med leverantören markerar du kryssrutan och väljer sedan **Auktorisera indirekt leverantör.** Leverantören visas nu på sidan **indirekta leverantörer** och ditt företag finns nu listat på leverantörens sida **indirekta återförsäljare.**
...
6. Välj **Bjud in nya** kunder för att be en ny kund att auktorisera återförsäljarrelationer med både dig och din indirekta leverantör på samma gång. Se till att ha kundens e-postadress till hands så att du kan skicka inbjudan till dem via e-post.  
   ...
   > [!IMPORTANT]  
   > Din indirekta leverantör måste ha en återförsäljarrelation med dina kunder för att kunna skicka beställningar åt dem.

## <a name="your-csp-country-and-the-csp-regions-where-you-do-business"></a>Ditt CSP-land och de CSP-regioner där du gör affärer

Din juridiska verksamhetsplats som en indirekt CSP-återförsäljare avgör med vilka indirekta leverantörer du kan arbeta samt de regioner där du kan utföra CSP-verksamhet. Läs mer genom att [läsa Molnlösningsleverantör program regionala marknader och valutor där du kan sälja CSP-erbjudanden.](regional-authorization-overview.md)
...
- [Kontoverifieringsprocessen](verification-responses.md)
...
- [Se partnerkrav för direktfakturering](direct-partner-new-requirements.md)
