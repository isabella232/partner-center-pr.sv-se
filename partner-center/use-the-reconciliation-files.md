...
ms.locfileid: "114844742"
---
# <a name="learn-how-to-read-the-line-items-in-your-partner-center-reconciliation-files"></a>Lär dig hur du läser radobjekten i dina Avstämningsfiler i Partnercenter
...
| MPN-ID | Beskrivning |
| ------ | ----------- |
| MPN-ID | Den Microsoft Partner Network (MPN) identifieraren för Molnlösningsleverantör (CSP)-partner (direkt eller indirekt). |
