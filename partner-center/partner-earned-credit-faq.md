...
## <a name="where-can-i-find-pec-details"></a>Var hittar jag information om PEC?
...
:::image type="content" source="images/advanced-specializations/partner-billing.png" alt-text="Skärmbild av fliken Fakturering i Partnercenter med återkommande köp och engångsköp framhävt." border="false":::
