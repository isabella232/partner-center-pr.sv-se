...
| MeterCategory | Namn på mätarkategorin | 
...
| CustomerMarket | Kundens geografiska marknad | 
| MPNId | Microsoft Partner Network kundens ID | 
| PartnerName | Namnet på partnern | 
...
| Månad | Månad då användning rapporteras | 
| RevSumDivisionName | Namnet på divisionen för rev-summa | 
...
| Månad | Månad då användning rapporteras | 
| Underarbetslast | Underlast för vilken användning rapporteras (möten, samtal eller telefonsystem) | 
| Skrivbordsanvändare | Antal användare som använder Teams på skrivbordet | 
...
| Skapa en motståndskraftig leveranskedja – Windows och aktivera första Dynamics 365-arbetsbelastning som Dynamics 365 Supply Chain Management med kunder som inte är Oracle- eller SAP ERP-kunder (resursplanering för företag) | Rikta in sig på kunder för Dynamics 365 Supply Chain Management | 
